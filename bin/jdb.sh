...
$JAVA_HOME/bin/jdb -sourcepath $EXIST_HOME/src $PROF $JAVA_OPTS -Djavax.xml.parsers.SAXParserFactory=$SAXFACTORY -Dexist.home=$EXIST_HOME -classpath $LOCALCLASSPATH $*
