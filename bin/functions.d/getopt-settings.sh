...
SHORT_CLIENT_OPTS="h,j,k:,l,C:,u:,P:,p:,o:,r:,c:,f:,g:,m:,R:,n:,O:,F:,t:,X:,T:,v,q,d,s,i,Q,N,x::"
LONG_CLIENT_OPTS="help,port:,jmx,jmx-port:,local,config:,user:,password:,parse:,option:,remove:,collection:,resource:,get:,mkcol:,rmcol:,howmany:,output:,file:,threads:,xupdate:,trace:,verbose,quiet,recurse-dirs,no-gui,reindex,query,no-embedded-mode,xpath::"

SHORT_STANDALONESERVER_OPTS="h,j,k:,d,p:,t:"
LONG_STANDALONESERVER_OPTS="help,jmx,jmx-port:,debug,http-port:,threads:"

SHORT_JETTYCONTAINER_OPTS="j,k:"
LONG_JETTYCONTAINER_OPTS="jmx,jmx-port:"
NR_JAVA_OPTS=0
declare -a JAVA_OPTS
