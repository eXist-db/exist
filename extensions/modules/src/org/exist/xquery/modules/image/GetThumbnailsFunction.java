...
public class GetThumbnailsFunction extends BasicFunction {
	...
	public final static FunctionSignature signature = new FunctionSignature(
			...
			"Get or generate thumbnails from the given database collection $a"
					...
					+ "You can leave $b empty then the default is 'rel:/thumbs'. The third argument specifies the dimension of the thumbnails, it can be empty then the default values are 'maxheight = 100' and 'maxwidth = 100', the first value of $c are 'maxheight' the second 'maxwidth'.",
			new SequenceType[] {
