...
public class ZipFunction extends BasicFunction {
    ...
    private void zipResource(ZipOutputStream zos, DocumentImpl doc,
            boolean useHierarchy, String stripOffset) throws IOException, SAXException {
	 ...
	 * @param useHierarchy Whether to use a folder hierarchy in the Zip file that reflects the collection hierarchy
	 */
    private void zipCollection(ZipOutputStream zos, Collection col, boolean useHierarchy,
            String stripOffset) throws IOException, SAXException, LockException {
