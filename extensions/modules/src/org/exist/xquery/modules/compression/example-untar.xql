...
let $zip := util:binary-doc("/db/example.tar") return
	compression:untar($zip, util:function(xs:QName("local:entry-filter"), 2), util:function(xs:QName("local:entry-data"), 3))