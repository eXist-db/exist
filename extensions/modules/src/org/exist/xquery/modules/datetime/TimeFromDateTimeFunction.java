...
public class TimeFromDateTimeFunction extends BasicFunction {
	...
	public final static FunctionSignature signature =
		new FunctionSignature(
			...
			"Returns the xs:time portion of the xs:dateTime",
			new SequenceType[] { 
				new FunctionParameterSequenceType("date-time", Type.DATE_TIME, Cardinality.EXACTLY_ONE, "The xs:dateTime to extract the time from.")
			},
			new FunctionParameterSequenceType("time", Type.TIME, Cardinality.EXACTLY_ONE, "The time extracted from the date-time"));
