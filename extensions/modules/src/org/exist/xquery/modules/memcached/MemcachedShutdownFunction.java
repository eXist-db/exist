...
public class MemcachedShutdownFunction extends BasicFunction
{
	...
	public final static FunctionSignature signatures[] = {
		new FunctionSignature(
			new QName( "shutdown", MemcachedModule.NAMESPACE_URI, MemcachedModule.PREFIX ),
				"Shutdown the client.",
				new SequenceType[]
  				{
	...
	public MemcachedShutdownFunction( XQueryContext context, FunctionSignature signature )
	{
