...
public class ExecuteFunction extends BasicFunction {
    ...
    public Sequence eval(final Sequence[] args, final Sequence contextSequence) throws XPathException {
        ...
        if (args.length == 5 || args.length == 6) {
            ...
            final String plSql = args[1].getStringValue();
            ...
            try {
                ...
                if (resultSetPos != 0) {
                    ...
                    while (resultSet.next()) {
                        ...
                        for (int i = 0; i < iColumns; i++) {
                            ...
                            if (columnName != null) {
                                final String colValue = resultSet.getString(i + 1);
                    ...
                    final NodeValue node = (NodeValue) builder.getDocument().getDocumentElement();

                    final Node count = node.getNode().getAttributes().getNamedItem("count");
                ...
                final ByteArrayOutputStream bufStackTrace = new ByteArrayOutputStream();
            ...
            for (int i = 0; i < paramElements.getLength(); i++) {
                ...
                try {
                    ...
                    if (sqlType == Types.DATE) {
                        final Date date = xmlDf.parse(value);
