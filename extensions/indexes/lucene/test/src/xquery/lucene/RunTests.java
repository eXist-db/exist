...
public class RunTests {
	...
	public void run() {
		try {
			...
			Source query = new FileSource(new File("extensions/indexes/lucene/test/src/xquery/lucene/runTests.xql"), 
				"UTF-8", false);
			for (File file : files) {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		File dir = new File("extensions/indexes/lucene/test/src/xquery/lucene");
