...
<xsl:stylesheet version="3.0"
    ...
    <!-- Canonical comments the vector module out by default; supply the live element ourselves. -->
    <xsl:param name="extra-modules" as="element()*">
        <module xmlns="" uri="http://exist-db.org/xquery/vector" class="org.exist.xquery.modules.vector.VectorModule"/>
    </xsl:param>
