...
public class Format_time extends BasicFunction {
	...
	public final static FunctionSignature signatures[] = {
		new FunctionSignature(
				new QName("format-time", XSLModule.NAMESPACE_URI, XSLModule.PREFIX),
                FormatFunctionConstants.TIME_FUNCTION_DESCRIPTION,
                new SequenceType[] { FormatFunctionConstants.TIME_PARAMETER, FormatFunctionConstants.PICTURE_PARAMETER, FormatFunctionConstants.LANGUAGE_PARAMETER, FormatFunctionConstants.CALENDAR_PARAMETER, FormatFunctionConstants.COUNTRY_PARAMETER},
                FormatFunctionConstants.RETURN_TYPE
		),
		new FunctionSignature(
				new QName("format-time", XSLModule.NAMESPACE_URI, XSLModule.PREFIX),
                FormatFunctionConstants.TIME_FUNCTION_DESCRIPTION,
                new SequenceType[] { FormatFunctionConstants.TIME_PARAMETER, FormatFunctionConstants.PICTURE_PARAMETER},
                FormatFunctionConstants.RETURN_TYPE
		)
	};
