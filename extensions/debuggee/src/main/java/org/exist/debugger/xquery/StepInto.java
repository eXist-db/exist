 ...
 */
public class StepInto extends BasicFunction {

	public final static FunctionSignature signatures[] = { 
		new FunctionSignature(
			new QName("step-into", Module.NAMESPACE_URI, Module.PREFIX), 
			"", 
			new SequenceType[] { 
	...
	public StepInto(XQueryContext context, FunctionSignature signature) {
