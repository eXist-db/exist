 ...
 */
public class StepOut extends BasicFunction {

	public final static FunctionSignature signatures[] = { 
		new FunctionSignature(
			new QName("step-out", Module.NAMESPACE_URI, Module.PREFIX), 
			"", 
			new SequenceType[] { 
	...
	public StepOut(XQueryContext context, FunctionSignature signature) {
