 ...
 */
public class BreakpointSet extends BasicFunction {

	public final static FunctionSignature signatures[] = { 
		new FunctionSignature(
			new QName("breakpoint-set", Module.NAMESPACE_URI, Module.PREFIX), 
			"", 
			new SequenceType[] { 
	...
	public BreakpointSet(XQueryContext context, FunctionSignature signature) {
