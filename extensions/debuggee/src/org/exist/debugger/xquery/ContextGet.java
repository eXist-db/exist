 ...
 */
public class ContextGet extends BasicFunction {

	public final static FunctionSignature signatures[] = { 
		new FunctionSignature(
			new QName("context-get", Module.NAMESPACE_URI, Module.PREFIX), 
			"", 
			new SequenceType[] { 
	...
	public ContextGet(XQueryContext context, FunctionSignature signature) {
