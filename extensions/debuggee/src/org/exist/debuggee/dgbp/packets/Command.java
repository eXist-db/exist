...
public abstract class Command extends DGBPPacket {
	...
	public static Command parse(String message) throws ParsingCommandException {
		...
		if (command.equals("feature_set")) {
			return new FeatureSet(args);
		
		} if (command.equals("step_into")) {
			return new StepInto(args);
		
		} if (command.equals("step_over")) {
			return new StepOver(args);
		
		} if (command.equals("step_out")) {
			return new StepOut(args);
		
		} if (command.equals("stack_get")) {
			return new StackGet(args);
