...
dojo.isString = function $DBAf_(/*anything*/ it){
	//	summary:
	//		Return true if it is a String
	return !!arguments.length && it != null && (typeof it == "string" || it instanceof String); // Boolean
}

dojo.isArray = function $DBAg_(/*anything*/ it){
	//	summary:
...
/*=====
dojo.isFunction = function $DBAh_(it){
...
dojo.isObject = function $DBAi_(/*anything*/ it){
	// summary: 
...
dojo.isArrayLike = function $DBAj_(/*anything*/ it){
	//	summary:
...
dojo.isAlien = function $DBAk_(/*anything*/ it){
	// summary: 
...
dojo.extend = function $DBAl_(/*Object*/ constructor, /*Object...*/ props){
	// summary:
...
dojo._hitchArgs = function $DBAm_(scope, method /*,...*/){
...
dojo.hitch = function $DBAn_(/*Object*/scope, /*Function|String*/method /*,...*/){
	//	summary: 
...
/*=====
dojo.delegate = function $DBAo_(obj, props){
	//	summary:
...
/*=====
dojo._toArray = function $DBAp_(obj, offset, startWith){
	//	summary:
...
dojo.partial = function $DBAq_(/*Function|String*/method /*, ...*/){
	//	summary:
...
dojo.clone = function $DBAr_(/*anything*/ o){
	// summary:
...
dojo.declare = function $DA8i_(/*String*/ className, /*Function|Function[]*/ superclass, /*Object*/ props){
	//	summary: 
...
dojo.mixin(dojo.declare, {
	_delegate: function $DA8b_(base, mixin){
	...
	_core: { 
		...
		_findMixin: function $DA8f_(mixin){
		...
		_findMethod: function $DA8g_(name, method, ptype, has){
		...
		inherited: function $DA8h_(name, args, newArgs){
...
dojo._listener = {
	...
	add: function $DA8R_(/*Object*/ source, /*String*/ method, /*Function*/ listener){
	...
	remove: function $DA8S_(/*Object*/ source, /*String*/ method, /*Handle*/ handle){
...
dojo.connect = function $DA8T_(/*Object|null*/ obj, 
						/*String*/ event, 
						/*Object|null*/ context, 
...
dojo._connect = function $DA8U_(obj, event, context, method){
	var l=dojo._listener, h=l.add(obj, event, dojo.hitch(context, method)); 
	return [obj, event, h, l]; // Handle
}

dojo.disconnect = function $DA8V_(/*Handle*/ handle){
	// summary:
...
dojo._disconnect = function $DA8W_(obj, event, handle, listener){
...
dojo.subscribe = function $DA8X_(/*String*/ topic, /*Object|null*/ context, /*String|Function*/ method){
	//	summary:
...
dojo.unsubscribe = function $DA8Y_(/*Handle*/ handle){
	//	summary:
...
dojo.publish = function $DA8Z_(/*String*/ topic, /*Array*/ args){
	//	summary:
...
dojo.connectPublisher = function $DA8a_(	/*String*/ topic, 
									/*Object|null*/ obj, 
									/*String*/ event){
	//	summary:
...
dojo.Deferred = function $DA8v_(/*Function?*/ canceller){
	// summary:
...
dojo.extend(dojo.Deferred, {
	...
	*/
	...
	errback: function $DA8p_(/*Error*/res){
		//	summary: 
	...
	addBoth: function $DA8q_(/*Function|Object*/cb, /*String?*/cbfn){
		//	summary:
...
dojo.fromJson = function $DBAc_(/*String*/ json){
	// summary:
...
dojo._escapeString = function $DBAd_(/*String*/str){
	//summary:
...
dojo.toJson = function $DBAe_(/*Object*/ it, /*Boolean?*/ prettyPrint, /*String?*/ _indentStr){
	// summary:
...
(function(){
	...
	dojo.mixin(dojo, {
		indexOf: function $DA74_(	/*Array*/		array, 
							/*Object*/		value,
							/*Integer?*/	fromIndex,
							/*Boolean?*/	findLast){
			// summary:
		...
		lastIndexOf: function $DA75_(/*Array*/array, /*Object*/value, /*Integer?*/fromIndex){
			// summary:
		...
		forEach: function $DA76_(/*Array|String*/arr, /*Function|String*/callback, /*Object?*/thisObject){
			//	summary:
		...
		_everyOrSome: function $DA77_(/*Boolean*/every, /*Array|String*/arr, /*Function|String*/callback, /*Object?*/thisObject){
			var _p = _getParts(arr, thisObject, callback); arr = _p[0];
			for(var i=0,l=arr.length; i<l; ++i){
		...
		every: function $DA78_(/*Array|String*/arr, /*Function|String*/callback, /*Object?*/thisObject){
			// summary:
		...
		some: function $DA79_(/*Array|String*/arr, /*Function|String*/callback, /*Object?*/thisObject){
			// summary:
		...
		map: function $DA8A_(/*Array|String*/arr, /*Function|String*/callback, /*Function?*/thisObject){
			// summary:
		...
		filter: function $DA8B_(/*Array*/arr, /*Function|String*/callback, /*Object?*/thisObject){
			// summary:
...
(function(){
	...
	dojo.Color = function $DA8K_(/*Array|String|Object*/ color){
		// summary:
	...
	dojo.extend(dojo.Color, {
		...
		_set: function $DA8C_(r, g, b, a){
			var t = this; t.r = r; t.g = g; t.b = b; t.a = a;
		},
		setColor: function $DA8D_(/*Array|String|Object*/ color){
			// summary:
			//		Takes a named string, hex string, array of rgb or rgba values,
			//		an object with r, g, b, and a properties, or another `dojo.Color` object
		...
		toCss: function $DA8I_(/*Boolean?*/ includeAlpha){
	...
	dojo.colorFromRgb = function $DA8M_(/*String*/ color, /*dojo.Color?*/ obj){
		// summary: get rgb(a) array from css-style color declarations
		var m = color.toLowerCase().match(/^rgba?\(([\s\.,0-9]+)\)/);
		return m && dojo.colorFromArray(m[1].split(/\s*,\s*/), obj);	// dojo.Color
	};

	dojo.colorFromHex = function $DA8N_(/*String*/ color, /*dojo.Color?*/ obj){
	...
	dojo.colorFromArray = function $DA8O_(/*Array*/ a, /*dojo.Color?*/ obj){
	...
	dojo.colorFromString = function $DA8P_(/*String*/ str, /*dojo.Color?*/ obj){
		//	summary:
...
dojo.setContext = function $DBCR_(/*Object*/globalObject, /*DocumentElement*/globalDocument){
	// summary:
...
dojo.withGlobal = function $DBCS_(	/*Object*/globalObject, 
							/*Function*/callback, 
							/*Object?*/thisObject, 
							/*Array?*/cbArguments){
	// summary:
...
dojo.withDoc = function $DBCT_(	/*DocumentElement*/documentObject, 
							/*Function*/callback, 
							/*Object?*/thisObject, 
							/*Array?*/cbArguments){
	// summary:
...
(function(){
	...
	var del = (dojo._event_listener = {
		add: function $DA8x_(/*DOMNode*/node, /*String*/name, /*Function*/fp){
			if(!node){return;} 
		...
		remove: function $DA8y_(/*DOMNode*/node, /*String*/event, /*Handle*/handle){
			// summary:
		...
		_normalizeEventName: function $DA8z_(/*String*/name){
			// Generally, name should be lower case, unless it is special
			// somehow (e.g. a Mozilla DOM event).
			// Remove 'on'.
			return name.slice(0,2) =="on" ? name.slice(2) : name;
		},
		_fixCallback: function $DA80_(/*String*/name, fp){
		...
		_fixEvent: function $DA81_(evt, sender){
		...
		_setKeyChar: function $DA82_(evt){
	...
	dojo.fixEvent = function $DA9J_(/*Event*/evt, /*DOMNode*/sender){
		// summary:
	...
	dojo.stopEvent = function $DA9K_(/*Event*/evt){
		// summary:
	...
	dojo._connect = function $DA9L_(obj, event, context, method, dontFix){
	...
	dojo._disconnect = function $DA9M_(obj, event, handle, listener){
	...
	if(dojo.isIE){ 
		...
		if(!dojo.config._allow_leaks){
			...
			node_listener = iel = dojo._ie_listener = {
				...
				handlers: [],
				// add a listener to an object
				add: function $DA83_(/*Object*/ source, /*String*/ method, /*Function*/ listener){
					source = source || dojo.global;
					var f = source[method];
				...
				// remove a listener from an object
				remove: function $DA84_(/*Object*/ source, /*String*/ method, /*Handle*/ handle){
		...
		dojo.mixin(del, {
			add: function $DA85_(/*DOMNode*/node, /*String*/event, /*Function*/fp){
			...
			remove: function $DA86_(/*DOMNode*/node, /*String*/event, /*Handle*/handle){
				event = del._normalizeEventName(event);
			...
			_normalizeEventName: function $DA87_(/*String*/eventName){
			...
			_nop: function $DA88_(){},
			_fixEvent: function $DA89_(/*Event*/evt, /*DOMNode*/sender){
				// summary:
				//		normalizes properties on the event object including event
				//		bubbling methods, keystroke normalization, and x/y positions
			...
			_stealthKeyDown: function $DA9B_(evt){
			...
			_stopPropagation: function $DA9C_(){
				this.cancelBubble = true; 
			},
			_preventDefault: function $DA9D_(){
		...
		dojo.stopEvent = function $DA9N_(evt){
	...
	del._synthesizeEvent = function $DA9O_(evt, props){
			var faux = dojo.mixin({}, evt, props);
			del._setKeyChar(faux);
			// FIXME: would prefer to use dojo.hitch: dojo.hitch(evt, evt.preventDefault); 
			// but it throws an error when preventDefault is invoked on Safari
			// does Event.preventDefault not support "apply" on Safari?
			faux.preventDefault = function $DA9P_(){ evt.preventDefault(); }; 
			faux.stopPropagation = function $DA9Q_(){ evt.stopPropagation(); }; 
			return faux;
	}
	...
	if(dojo.isOpera){
		dojo.mixin(del, {
			_fixEvent: function $DA9E_(evt, sender){
				switch(evt.type){
					case "keypress":
						var c = evt.which;
						if(c==3){
	...
	if(dojo.isWebKit){
		...
		dojo.mixin(del, {
			add: function $DA9F_(/*DOMNode*/node, /*String*/event, /*Function*/fp){
				if(!node){return;} // undefined
			...
			remove: function $DA9G_(/*DOMNode*/node, /*String*/event, /*Handle*/handle){
				if(node){
			...
			_fixEvent: function $DA9H_(evt, sender){
				switch(evt.type){
					case "keypress":
...
if(dojo.isIE){
	...
	dojo._ieDispatcher = function $DA9R_(args, sender){
	...
	dojo._getIeDispatcher = function $DA9S_(){
		// ensure the returned function closes over nothing ("new Function" apparently doesn't close)
		return new Function(dojo._scopeName + "._ieDispatcher(arguments, this)"); // function
	}
	// keep this out of the closure to reduce RAM allocation
	dojo._event_listener._fixCallback = function $DA9T_(fp){
...
/*=====
dojo.byId = function $DA9r_(id, doc){
	//	summary:
...
if(dojo.isIE || dojo.isOpera){
	dojo.byId = function $DA9s_(id, doc){
		if(dojo.isString(id)){
			var _d = doc || dojo.doc;
	...
	dojo.byId = function $DA9t_(id, doc){
...
/*=====
	dojo._destroyElement = function $DA9u_(node){
...
=====*/
	...
	dojo.isDescendant = function $DA9v_(/*DomNode|String*/node, /*DomNode|String*/ancestor){
		//	summary:
	...
	dojo.setSelectable = function $DA9w_(/*DomNode|String*/node, /*Boolean*/selectable){
	...
	dojo.place = function $DA9x_(node, refNode, position){
		//	summary:
...
/*=====
	dojo.getComputedStyle = function $DA9y_(node){
		//	summary:
...
=====*/
	...
	var gcs;
		if(d.isWebKit){
			gcs = function $DA9z_(/*DomNode*/node){
			var s;
			if(node.nodeType == 1){
		...
		gcs = function $DA90_(node){
			// IE (as of 7) doesn't expose Element like sane browsers
			return node.nodeType == 1 /* ELEMENT_NODE*/ ? node.currentStyle : {};
		};
	}else{
		gcs = function $DA91_(node){
		...
		if(!d.isIE){
			d._toPixelValue = function $DA92_(element, value){
			// style values can be floats, client code may want
			// to round for integer pixels.
			return parseFloat(value) || 0; 
		};
		}else{
		d._toPixelValue = function $DA93_(element, avalue){
			if(!avalue){ return 0; }
	...
	/*=====
	dojo._getOpacity = function $DA94_(node){
			//	summary:
	...
	/*=====
	dojo._setOpacity = function $DA95_(node, opacity){
			//	summary:
	...
	dojo.style = function $DA96_(	/*DomNode|String*/ node, 
							/*String?|Object?*/ style, 
							/*String?*/ value){
		//	summary:
	...
	dojo._getPadExtents = function $DA97_(/*DomNode*/n, /*Object*/computedStyle){
		//	summary:
	...
	dojo._getBorderExtents = function $DA98_(/*DomNode*/n, /*Object*/computedStyle){
		//	summary:
	...
	dojo._getPadBorderExtents = function $DA99_(/*DomNode*/n, /*Object*/computedStyle){
		//	summary:
	...
	dojo._getMarginExtents = function $DBAA_(n, computedStyle){
		//	summary:
		//		returns object with properties useful for box fitting with
	...
	dojo._getMarginBox = function $DBAB_(/*DomNode*/node, /*Object*/computedStyle){
		// summary:
	...
	dojo._getContentBox = function $DBAC_(node, computedStyle){
		// summary:
		//		Returns an object that encodes the width, height, left and top
	...
	dojo._getBorderBox = function $DBAD_(node, computedStyle){
		var s = computedStyle || gcs(node), 
			pe = d._getPadExtents(node, s),
	...
	dojo._setBox = function $DBAE_(/*DomNode*/node, /*Number?*/l, /*Number?*/t, /*Number?*/w, /*Number?*/h, /*String?*/u){
		//	summary:
	...
	dojo._isButtonTag = function $DBAF_(/*DomNode*/node) {
		// summary:
	...
	dojo._usesBorderBox = function $DBAG_(/*DomNode*/node){
		//	summary: 
	...
	dojo._setContentSize = function $DBAH_(/*DomNode*/node, /*Number*/widthPx, /*Number*/heightPx, /*Object*/computedStyle){
		//	summary:
	...
	dojo._setMarginBox = function $DBAI_(/*DomNode*/node, 	/*Number?*/leftPx, /*Number?*/topPx, 
	...
	dojo.marginBox = function $DBAJ_(/*DomNode|String*/node, /*Object?*/box){
		//	summary:
	...
	dojo.contentBox = function $DBAK_(/*DomNode|String*/node, /*Object?*/box){
		//	summary:
	...
	dojo._docScroll = function $DBAL_(){
		var 
			_b = d.body(),
			_w = d.global,
	...
	dojo._isBodyLtr = function $DBAM_(){
		//FIXME: could check html and body tags directly instead of computed style?  need to ignore case, accept empty values
		return ("_bodyLtr" in d) ? d._bodyLtr :
			d._bodyLtr = gcs(d.body()).direction == "ltr"; // Boolean 
	}
	
		dojo._getIeDocumentElementOffset = function $DBAN_(){
		// summary
	...
	dojo._fixIeBiDiScrollLeft = function $DBAO_(/*Integer*/ scrollLeft){
	...
	dojo._abs = function $DBAP_(/*DomNode*/node, /*Boolean?*/includeScroll){
		//	summary:
	...
	dojo.coords = function $DBAQ_(/*DomNode|String*/node, /*Boolean?*/includeScroll){
		//	summary:
	...
	dojo.hasAttr = function $DBAR_(/*DomNode|String*/node, /*String*/name){
		//	summary:
	...
	dojo.attr = function $DBAS_(/*DomNode|String*/node, /*String|Object*/name, /*String?*/value){
		//	summary:
	...
	dojo.removeAttr = function $DBAT_(/*DomNode|String*/node, /*String*/name){
		//	summary:
	...
	dojo.create = function $DBAU_(tag, attrs, refNode, pos){
	...
	/*=====
	dojo.empty = function $DBAV_(node){
			//	summary:
	...
	/*=====
	dojo._toDom = function $DBAW_(frag, doc){
			//	summary:
	...
	d._toDom = function $DBAX_(frag, doc){
	...
	dojo.hasClass = function $DBAY_(/*DomNode|String*/node, /*String*/classStr){
		//	summary:
	...
	dojo.addClass = function $DBAZ_(/*DomNode|String*/node, /*String*/classStr){
		//	summary:
	...
	dojo.removeClass = function $DBAa_(/*DomNode|String*/node, /*String*/classStr){
	...
	dojo.toggleClass = function $DBAb_(/*DomNode|String*/node, /*String*/classStr, /*Boolean?*/condition){
		//	summary:
...
(function(){
	...
	dojo.extend(dojo.NodeList, {
		...
		/*=====
		slice: function $DBAt_(begin, end){
			// summary:
		...
		splice: function $DBAu_(index, howmany, item){
			// summary:
		...
		indexOf: function $DBAv_(value, fromIndex){
			//	summary:
		...
		lastIndexOf: function $DBAw_(value, fromIndex){
			// summary:
		...
		every: function $DBAx_(callback, thisObject){
			//	summary:
		...
		some: function $DBAy_(callback, thisObject){
			//	summary:
			//		Takes the same structure of arguments and returns as
		...
		map: function $DBA0_(/*Function*/ func, /*Function?*/ obj){
			//	summary:
		...
		forEach: function $DBA1_(callback, thisObj){
			//	summary:
		...
		attr: function $DBA3_(property, value){
			//	summary:
		...
		style: function $DBA4_(property, value){
			//	summary:
		...
		addClass: function $DBA5_(className){
			//	summary:
		...
		removeClass: function $DBA6_(className){
			//	summary:
		...
		toggleClass: function $DBA7_(className, condition){
			//	summary:
			//		Adds a class to node if not present, or removes if present.
			//		Pass a boolean condition if you want to explicitly add or remove.
			//	condition: Boolean?
		...
		connect: function $DBA8_(methodName, objOrFunc, funcName){
			//	summary:
		...
		*/
		...
		place: function $DBBB_(/*String||Node*/ queryOrNode, /*String*/ position){
			//	summary:
		...
		orphan: function $DBBC_(/*String?*/ simpleFilter){
			//	summary:
		...
		adopt: function $DBBD_(/*String||Array||DomNode*/ queryOrListOrNode, /*String?*/ position){
			//	summary:
		...
		query: function $DBBE_(/*String*/ queryStr){
			//	summary:
		...
		filter: function $DBBF_(/*String|Function*/ simpleFilter){
			//	summary:
		...
		*/
		...
		addContent: function $DBBH_(/*String|DomNode*/ content, /*String||Integer?*/ position){
			//	summary:
		...
		instantiate: function $DBBI_(/*String|Object*/ declaredClass, /*Object?*/ properties){
			//	summary:
...
;(function(d){
	...
	*/
	...
	var getElementsFunc = function(query){
		...
		if(!oper){
			...
			if(query.id){
				...
				retFunc = function $DBCJ_(root, arr){
				...
				retFunc = function $DBCK_(root, arr, bag){
				...
				retFunc = function $DBCL_(root, arr, bag){
					var ret = getArr(0, arr), te, x=0;
				...
				retFunc = function $DBCM_(root, arr, bag){
					var ret = getArr(0, arr), te, x=0;
	...
	// the main executor
	d.query = function $DBCN_(/*String*/ query, /*String|DOMNode?*/ root){
		//	summary:
	...
	d._filterQueryResult = function $DBCO_(nodeList, simpleFilter){
...
(function(){
	...
	dojo.formToObject = function $DBCZ_(/*DOMNode||String*/ formNode){
		// summary:
	...
	dojo.objectToQuery = function $DBCa_(/*Object*/ map){
		//	summary:
	...
	dojo.formToQuery = function $DBCb_(/*DOMNode||String*/ formNode){
		// summary:
	...
	dojo.formToJson = function $DBCc_(/*DOMNode||String*/ formNode, /*Boolean?*/prettyPrint){
		// summary:
	...
	dojo.queryToObject = function $DBCd_(/*String*/ str){
		// summary:
	...
	*/
	...
	dojo._contentHandlers = {
		text: function $DBCU_(xhr){ return xhr.responseText; },
		json: function $DBCV_(xhr){
		...
		javascript: function $DBCW_(xhr){ 
			// FIXME: try Moz and IE specific eval variants?
			return _d.eval(xhr.responseText);
		},
		xml: function $DBCX_(xhr){
	...
	/*=====
	dojo.__IoCallbackArgs = function $DBCf_(args, xhr, url, query, handleAs, id, canDelete, json){
		//	args: Object
	...
	dojo._ioSetArgs = function $DBCg_(/*dojo.__IoArgs*/args,
			/*Function*/canceller,
			/*Function*/okHandler,
			/*Function*/errHandler){
		//	summary: 
	...
	dojo._ioCancelAll = function $DBCh_(){
	...
	_d._ioWatch = function $DBCi_(/*Deferred*/dfd,
		/*Function*/validCheck,
		/*Function*/ioCheck,
		/*Function*/resHandle){
	...
	dojo._ioAddQueryToUrl = function $DBCj_(/*dojo.__IoCallbackArgs*/ioArgs){
	...
	dojo.xhr = function $DBCk_(/*String*/ method, /*dojo.__XhrArgs*/ args, /*Boolean?*/ hasBody){
		//	summary:
	...
	dojo.xhrGet = function $DBCl_(/*dojo.__XhrArgs*/ args){
		//	summary: 
	...
	dojo.xhrDelete = function $DBCm_(/*dojo.__XhrArgs*/ args){
		//	summary:
	...
	/*
	dojo.wrapForm = function $DBCn_(formNode){
		//summary:
...
(function(){ 
	...
	dojo._Line = function $DA9f_(/*int*/ start, /*int*/ end){
		//	summary:
	...
	dojo._Line.prototype.getValue = function $DA9g_(/*float*/ n){
	...
	d.declare("dojo._Animation", null, {
		...
		//		returned.
		constructor: function $DA9U_(/*Object*/ args){
			_mixin(this, args);
	...
	=====*/
		...
		_fire: function $DA9V_(/*Event*/ evt, /*Array?*/ args){
			//	summary:
		...
		play: function $DA9W_(/*int?*/ delay, /*Boolean?*/ gotoStart){
			// summary:
			//		Start the animation.
			// delay:
		...
		_play: function $DA9X_(gotoStart){
			var _t = this;
			if(_t._delayTimer){ _t._clearTimer(); }
		...
		gotoPercent: function $DA9Z_(/*Decimal*/ percent, /*Boolean?*/ andPlay){
			//	summary:
		...
		stop: function $DA9a_(/*boolean?*/ gotoEnd){
	...
	dojo._Animation.prototype._startTimer = function $DA9h_(){
	...
	dojo._Animation.prototype._stopTimer = function $DA9i_(){
		if(this._timer){
	...
	dojo._fade = function $DA9j_(/*Object*/ args){
		//	summary: 
	...
	/*=====
	dojo.__FadeArgs = function $DA9k_(node, duration, easing){
		// 	node: DOMNode|String
	...
	dojo.fadeIn = function $DA9l_(/*dojo.__FadeArgs*/ args){
		// summary: 
	...
	dojo.fadeOut = function $DA9m_(/*dojo.__FadeArgs*/  args){
		// summary: 
	...
	dojo._defaultEasing = function $DA9n_(/*Decimal?*/ n){
	...
	PropLine.prototype.getValue = function $DA9o_(r){
		var ret = {};
	...
	dojo.animateProperty = function $DA9p_(/*dojo.__AnimArgs*/ args){
		//	summary: 
	...
	dojo.anim = function $DA9q_(	/*DOMNode|String*/ 	node, 
							/*Object*/ 			properties, 
							/*Integer?*/		duration, 
							/*Function?*/		easing, 
							/*Function?*/		onEnd,
