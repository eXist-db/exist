...
This is the GitHub repository for the [eXist](http://www.exist-db.org "eXist") Native XML Database. 
...
If you want to contribute to eXist, please read [BUILD.md](BUILD.md) on how to build the code, and [CONTRIBUTING.md] (CONTRIBUTING.md) about how to share your work with the project.
