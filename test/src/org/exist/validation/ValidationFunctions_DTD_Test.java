...
public class ValidationFunctions_DTD_Test extends TestCase {
    ...
    public void testValidateUsingSystemCatalog() {
        ...
        try {
            ...
            result = service.query(
                "validation:validate('/db/validationtest/tmp/hamlet_valid.xml')");
    ...
    public void testSpecifiedCatalog() {
        ...
        try {
            logger.info("Test1");
            result = service.query(
                "validation:validate('/db/validationtest/hamlet_valid.xml',"
            ...
            logger.info("Test2");
            result = service.query(
                "validation:validate('/db/validationtest/hamlet_invalid.xml',"
                +"'/db/validationtest/dtd/catalog.xml')");
            r = (String) result.getResource(0).getContent();
