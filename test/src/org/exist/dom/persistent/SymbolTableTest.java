...
public class SymbolTableTest {
    ...
    private final SymbolTable createSymbolTable() throws BrokerPoolServiceException {
        final SymbolTable symbolTable = new SymbolTable();
        final Configuration configuration = createMock(Configuration.class);
        expect(configuration.getProperty(BrokerPool.PROPERTY_DATA_DIR)).andReturn(tmpDir);
    ...
    @Test
    public void getName_returns_empty_string_when_id_is_zero() throws EXistException, IOException, BrokerPoolServiceException {
    ...
    @Test
    public void getNameSpace_returns_empty_string_when_id_is_zero() throws EXistException, BrokerPoolServiceException {
        final SymbolTable symbolTable = createSymbolTable();
        assertEquals("", symbolTable.getNamespace((short)0));
    }

    @Test
    public void geMimeType_returns_empty_string_when_id_is_zero() throws EXistException, IOException, BrokerPoolServiceException {
        final SymbolTable symbolTable = createSymbolTable();
    ...
    public void getSymbol_for_localName_throws_exception_when_name_is_empty_string() throws EXistException, IOException, BrokerPoolServiceException {
        final SymbolTable symbolTable = createSymbolTable();
    ...
    @Test
    public void getNSSymbol_returns_zero_when_namespace_is_null() throws EXistException, IOException, BrokerPoolServiceException {
        final SymbolTable symbolTable = createSymbolTable();
    ...
    @Test
    public void getNSSymbol_returns_zero_when_namespace_is_empty_string() throws EXistException, IOException, BrokerPoolServiceException {
        final SymbolTable symbolTable = createSymbolTable();
    ...
    @Test
    public void localName_ids_are_stable() throws EXistException, IOException, BrokerPoolServiceException {
    ...
    @Test
    public void namespace_ids_are_stable() throws EXistException, IOException, BrokerPoolServiceException {
        SymbolTable symbolTable = createSymbolTable();
    ...
    @Test
    public void mimetype_ids_are_stable() throws EXistException, IOException, BrokerPoolServiceException {
        SymbolTable symbolTable = createSymbolTable();
    ...
    @Test
    public void write_and_read_are_balanced() throws EXistException, IOException, BrokerPoolServiceException {
        final SymbolTable symbolTable = createSymbolTable();
    ...
    @Test
    public void readLegacyFormat() throws EXistException, IOException, BrokerPoolServiceException {
        final SymbolTable symbolTable = createSymbolTable();
        VariableByteInput mockIs = createMock(VariableByteInput.class);
