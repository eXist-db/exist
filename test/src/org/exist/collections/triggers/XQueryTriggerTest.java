...
public class XQueryTriggerTest {
    ...
    private final String COLLECTION_CONFIG =
	    ...
	    "  <exist:triggers>" +
		"     <exist:trigger event='store-document'" +
		...
		"     <exist:trigger event='remove-document'" +
		"                    class='org.exist.collections.triggers.XQueryTrigger'>" +
    ...
    public void storeDocument() {
    	...
    	try {    		
	        ...
	        //TODO : consistent URI !	        
	        result = service.query("/events/event[@id = 'trigger1'][event = 'STORE-DOCUMENT']");
	        assertEquals(2, result.getSize());	        
    ...
    public void deleteDocument() {
    	...
    	try {
	        ...
	        //TODO : consistent URI !	        
	        result = service.query("/events/event[@id = 'trigger3'][event = 'REMOVE-DOCUMENT']");
	        assertEquals(2, result.getSize());	        
    ...
    public void storeBinaryDocument() {
    	...
    	try {    		
	        ...
	        //TODO : consistent URI !	        
	        result = service.query("/events/event[@id = 'trigger1'][collection = '" + DBBroker.ROOT_COLLECTION +  "/" + TEST_COLLECTION + "'][uri = '" + DBBroker.ROOT_COLLECTION +  "/" + TEST_COLLECTION + "/" + BINARY_DOCUMENT_NAME + "'][event = 'STORE-DOCUMENT']");
	        assertEquals(2, result.getSize());
	        
	        //TODO : consistent URI !	        
	        result = service.query("/events/event[@id = 'trigger1'][@type = 'finish'][collection = '" + DBBroker.ROOT_COLLECTION +  "/" + TEST_COLLECTION + "'][uri = '" + DBBroker.ROOT_COLLECTION +  "/" + TEST_COLLECTION + "/" + BINARY_DOCUMENT_NAME + "'][event = 'STORE-DOCUMENT']/document");
	        assertEquals(1, result.getSize());
    ...
    public void deleteBinaryDocument() {
    	...
    	try {
	        ...
	        //TODO : consistent URI !	        
	        result = service.query("/events/event[@id = 'trigger3'][collection = '" + DBBroker.ROOT_COLLECTION +  "/" + TEST_COLLECTION + "'][uri = '" + DBBroker.ROOT_COLLECTION +  "/" + TEST_COLLECTION + "/" + BINARY_DOCUMENT_NAME + "'][event = 'REMOVE-DOCUMENT']");
	        assertEquals(2, result.getSize());	        
	        
	        //TODO : consistent URI !	        
	        result = service.query("/events/event[@id = 'trigger3'][@type = 'prepare'][collection = '" + DBBroker.ROOT_COLLECTION +  "/" + TEST_COLLECTION + "'][uri = '" + DBBroker.ROOT_COLLECTION +  "/" + TEST_COLLECTION + "/" + BINARY_DOCUMENT_NAME + "'][event = 'REMOVE-DOCUMENT']/document");
	        assertEquals(1, result.getSize());
	        assertEquals("<document>" + BINARY_DOCUMENT_CONTENT + "</document>", result.getResource(0).getContent().toString());        
