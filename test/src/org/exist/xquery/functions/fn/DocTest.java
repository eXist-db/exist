...
public class DocTest {
    ...
    public void setUp() throws Exception {
        ...
        root = DatabaseManager.getCollection(XmldbURI.EMBEDDED_SERVER_URI_PREFIX + "/db", "admin", "");
    ...
    public void testURLRewriter() throws XPathException, HttpException, IOException {
		...
		PostMethod method = new PostMethod("http://localhost:8080/exist/rest/test/text.xq");
