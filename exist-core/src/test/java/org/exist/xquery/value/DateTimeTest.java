...
public class DateTimeTest extends AbstractTimeRelatedTestCase {
	...
	public void create1() throws XPathException {
        new DateTimeValue(null, "2005-10-11");
	}

    @Test(expected = XPathException.class)
	public void create2() throws XPathException {
        new DateTimeValue(null, "10:00:00Z");
	}

    @Test
	public void stringFormat1() throws XPathException {
		final AbstractDateTimeValue v = new DateTimeValue(null, "2005-10-11T10:00:00Z");
		assertEquals("2005-10-11T10:00:00Z", v.getStringValue());
	}

    @Test
	public void stringFormat2() throws XPathException {
		final AbstractDateTimeValue v = new DateTimeValue(null, "2005-10-11T10:00:00-01:00");
	...
	public void stringFormat3() throws XPathException {
		final AbstractDateTimeValue v = new DateTimeValue(null, "2005-10-11T24:00:00");
		assertEquals("2005-10-12T00:00:00", v.getStringValue());
	}

    @Test
	public void stringFormat4() throws XPathException {
		final AbstractDateTimeValue v = new DateTimeValue(null, "2005-10-11T10:00:00-00:00");
		assertEquals("2005-10-11T10:00:00Z", v.getStringValue());
	}

    @Test
	public void stringFormat5() throws XPathException {
		final AbstractDateTimeValue v = new DateTimeValue(null, "2005-10-11T10:00:00.5");
		assertEquals("2005-10-11T10:00:00.5", v.getStringValue());
	}

    @Test
	public void stringFormat6() throws XPathException {
		final AbstractDateTimeValue v = new DateTimeValue(null, "2005-10-11T10:00:00.50");
		assertEquals("2005-10-11T10:00:00.5", v.getStringValue());
	}

    @Test
	public void stringFormat7() throws XPathException {
		final AbstractDateTimeValue v = new DateTimeValue(null, "2005-10-11T10:00:00.0");
		assertEquals("2005-10-11T10:00:00", v.getStringValue());
	}

    @Test
	public void stringFormat8() throws XPathException {
		final AbstractDateTimeValue v = new DateTimeValue(null, "2005-10-11T10:00:00");
		assertEquals("2005-10-11T10:00:00", v.getStringValue());
	}

    @Test
	public void getPart1() throws XPathException {
		final AbstractDateTimeValue v = new DateTimeValue(null, "2005-10-11T10:05:02.6Z");
	...
	public void getPart2() throws XPathException {
		final AbstractDateTimeValue v = new DateTimeValue(null, "2005-10-11T10:05:02");
		assertEquals(2005, v.getPart(AbstractDateTimeValue.YEAR));
		assertEquals(10, v.getPart(AbstractDateTimeValue.MONTH));
		assertEquals(11, v.getPart(AbstractDateTimeValue.DAY));
		assertEquals(10, v.getPart(AbstractDateTimeValue.HOUR));
	...
	public void convert1() throws XPathException {
		final AbstractDateTimeValue v1 = new DateTimeValue(null, "2005-10-11T10:05:02+05:00");
	...
	public void convert2() throws XPathException {
		final AbstractDateTimeValue v1 = new DateTimeValue(null, "2005-10-11T10:05:02");
	...
	public void convert3() throws XPathException {
		...
		assertDateEquals(new DateValue(null, "2005-10-11+05:00"), v2);
	}
	...
	public void convert4() throws XPathException {
		final AbstractDateTimeValue v1 = new DateTimeValue(null, "2005-10-11T10:05:02");
		final AtomicValue v2 = v1.convertTo(Type.DATE);
		assertDateEquals(new DateValue(null, "2005-10-11"), v2);
		assertEquals(Sequence.EMPTY_SEQUENCE, ((AbstractDateTimeValue) v2).getTimezone());
	}
	...
	public void convert5() throws XPathException {
		...
		assertDateEquals(new TimeValue(null, "10:05:02+05:00"), v2);
	}
	...
	public void convert6() throws XPathException {
		final AbstractDateTimeValue v1 = new DateTimeValue(null, "2005-10-11T10:05:02");
		final AtomicValue v2 = v1.convertTo(Type.TIME);
		assertDateEquals(new TimeValue(null, "10:05:02"), v2);
		assertEquals(Sequence.EMPTY_SEQUENCE, ((AbstractDateTimeValue) v2).getTimezone());
	}

    @Test
	public void convert7() throws XPathException {
		final AbstractDateTimeValue v1 = new DateTimeValue(null, "2005-10-11T10:05:02.123456");
		final AtomicValue v2 = v1.convertTo(Type.TIME);
		assertDateEquals(new TimeValue(null, "10:05:02.123456"), v2);
	}
	...
	public void getTimezone2() throws XPathException {
		final AbstractDateTimeValue v1 = new DateTimeValue(null, "2005-10-11T10:05:02+05:30");
		assertDurationEquals(new DayTimeDurationValue(null, "PT5H30M"), (AtomicValue) v1.getTimezone());
	}
	...
	public void getTimezone4() throws XPathException {
		final AbstractDateTimeValue v1 = new DateTimeValue(null, "2005-10-11T10:05:02Z");
		assertDurationEquals(new DayTimeDurationValue(null, "P0D"), (AtomicValue) v1.getTimezone());
	}

    @Test
	public void withoutTimezone1() throws XPathException {
		final AbstractDateTimeValue v1 = new DateTimeValue(null, "2002-03-07T10:00:00");
		assertEquals("2002-03-07T10:00:00", v1.withoutTimezone().toString());
	}

    @Test
	public void withoutTimezone2() throws XPathException {
		final AbstractDateTimeValue v1 = new DateTimeValue(null, "2002-03-07T10:00:00-07:00");
		assertEquals("2002-03-07T10:00:00", v1.withoutTimezone().toString());
	}
	...
	public void adjustedToTimezone3() throws XPathException {
		final AbstractDateTimeValue v1 = new DateTimeValue(null, "2002-03-07T10:00:00");
		final AbstractDateTimeValue v2 = v1.adjustedToTimezone(new DayTimeDurationValue(null, "-PT10H"));
	...
	public void adjustedToTimezone6() throws XPathException {
		final AbstractDateTimeValue v1 = new DateTimeValue(null, "2002-03-07T00:00:00+01:00");
		final AbstractDateTimeValue v2 = v1.adjustedToTimezone(new DayTimeDurationValue(null, "-PT8H"));
	...
	public void adjustedToTimezone7() throws XPathException {
		final AbstractDateTimeValue v1 = new DateTimeValue(null, "2002-03-07T00:00:00+01:00");
        v1.adjustedToTimezone(new DayTimeDurationValue(null, "-PT15H"));
	}

    @Test(expected = XPathException.class)
	public void adjustedToTimezone8() throws XPathException {
		final AbstractDateTimeValue v1 = new DateTimeValue(null, "2002-03-07T00:00:00+01:00");
        v1.adjustedToTimezone(new DayTimeDurationValue(null, "PT14H01M"));
	}

    @Test(expected = XPathException.class)
	public void adjustedToTimezone9() throws XPathException {
		final AbstractDateTimeValue v1 = new DateTimeValue(null, "2002-03-07T00:00:00+01:00");
        v1.adjustedToTimezone(new DayTimeDurationValue(null, "PT8H4S"));
	}

    @Test
	public void adjustedToTimezone10() throws XPathException {
		final AbstractDateTimeValue v1 = new DateTimeValue(null, "2002-03-07T00:00:00");
		final AbstractDateTimeValue v2 = v1.adjustedToTimezone(new DayTimeDurationValue(null, "PT14H"));
	...
	public void compare1() throws XPathException {
		final AbstractDateTimeValue v1 = new DateTimeValue(null, "2002-04-02T12:00:00-01:00");
		final AbstractDateTimeValue v2 = new DateTimeValue(null, "2002-04-02T17:00:00+04:00");
	...
	public void compare2() throws XPathException {
		final AbstractDateTimeValue  v1 = new DateTimeValue(null, "2002-04-02T12:00:00");
		final AbstractDateTimeValue v2 = new DateTimeValue(null, "2002-04-02T23:00:00+06:00");
		assertEquals(0, v1.compareTo(null, v2));
		assertEquals(0, v2.compareTo(null, v1));
	}
	...
	public void compare3() throws XPathException {
		final AbstractDateTimeValue v1 = new DateTimeValue(null, "2002-04-02T12:00:00");
		final AbstractDateTimeValue v2 = new DateTimeValue(null, "2002-04-02T17:00:00");
	...
	public void compare4() throws XPathException {
		final AbstractDateTimeValue v1 = new DateTimeValue(null, "2002-04-02T12:00:00");
		final AbstractDateTimeValue v2 = new DateTimeValue(null, "2002-04-02T12:00:00");
		assertEquals(0, v1.compareTo(null, v2));
		assertEquals(0, v2.compareTo(null, v1));
	}
	...
	public void compare5() throws XPathException {
		final AbstractDateTimeValue v1 = new DateTimeValue(null, "2002-04-02T23:00:00-04:00");
		final AbstractDateTimeValue v2 = new DateTimeValue(null, "2002-04-03T02:00:00-01:00");
		assertEquals(0, v1.compareTo(null, v2));
		assertEquals(0, v2.compareTo(null, v1));
	}
	...
	public void compare8() throws XPathException {
		final AbstractDateTimeValue v1 = new DateTimeValue(null, "2006-09-14T04:15:16.559+04:00");
		final AbstractDateTimeValue v2 = new DateTimeValue(null, "2006-10-14T04:15:16.559+04:00");
	...
	public void plus1() throws XPathException {
		final AbstractDateTimeValue t = new DateTimeValue(null, "2000-10-30T11:12:00");
		final DurationValue d = new YearMonthDurationValue(null, "P1Y2M");
		final AbstractDateTimeValue r = new DateTimeValue(null, "2001-12-30T11:12:00");
		assertDateEquals(r, t.plus(d));
	}

    @Test
	public void plus2() throws XPathException {
		final AbstractDateTimeValue t = new DateTimeValue(null, "2000-10-30T11:12:00Z");
		final DurationValue d = new YearMonthDurationValue(null, "P1Y2M");
		final AbstractDateTimeValue r = new DateTimeValue(null, "2001-12-30T11:12:00Z");
		assertDateEquals(r, t.plus(d));
	}
	...
	public void plus3() throws XPathException {
		final AbstractDateTimeValue t = new DateTimeValue(null, "2000-10-30T11:12:00");
		final DurationValue d = new DayTimeDurationValue(null, "P3DT1H15M");
		final AbstractDateTimeValue r = new DateTimeValue(null, "2000-11-02T12:27:00");
		assertDateEquals(r, t.plus(d));
	}
	...
	public void plus4() throws XPathException {
		final AbstractDateTimeValue t = new DateTimeValue(null, "2000-10-30T11:12:00Z");
		final DurationValue d = new DayTimeDurationValue(null, "P3DT1H15M");
		final AbstractDateTimeValue r = new DateTimeValue(null, "2000-11-02T12:27:00Z");
		assertDateEquals(r, t.plus(d));
	}

    @Test
	public void minus1() throws XPathException {
		final AbstractDateTimeValue t1 = new DateTimeValue(null, "2000-10-30T06:12:00");
		final AbstractDateTimeValue t2 = new DateTimeValue(null, "1999-11-28T09:00:00Z");
		final DurationValue d = new DayTimeDurationValue(null, "P337DT2H12M");
	...
	public void minus2() throws XPathException {
		final AbstractDateTimeValue t = new DateTimeValue(null, "2000-10-30T11:12:00");
		final DurationValue d = new YearMonthDurationValue(null, "P1Y2M");
		final AbstractDateTimeValue r = new DateTimeValue(null, "1999-08-30T11:12:00");
	...
	public void minus3() throws XPathException {
		final AbstractDateTimeValue t = new DateTimeValue(null, "2000-10-30T11:12:00");
		final DurationValue d = new DayTimeDurationValue(null, "P3DT1H15M");
		final AbstractDateTimeValue r = new DateTimeValue(null, "2000-10-27T09:57:00");
		assertDateEquals(r, t.minus(d));
	}
}
