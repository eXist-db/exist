...
public class DayTimeDurationTest extends AbstractTimeRelatedTestCase {
    ...
    public void create1() throws XPathException {
        new DayTimeDurationValue(null, "P1Y4M");
    }

    @Test(expected = XPathException.class)
    public void create2() throws XPathException {
        new DayTimeDurationValue(null, "P1Y");
    }

    @Test(expected = XPathException.class)
    public void create3() throws XPathException {
        new DayTimeDurationValue(null, "P4M");
    }

    @Test
    public void stringFormat1() throws XPathException {
        final DurationValue dv = new DayTimeDurationValue(null, "P3DT1H2M3S");
        assertEquals("P3DT1H2M3S", dv.getStringValue());
    }

    @Test
    public void stringFormat2() throws XPathException {
        final DurationValue dv = new DayTimeDurationValue(null, "P1DT25H65M66.5S");
        assertEquals("P2DT2H6M6.5S", new DurationValue(null, dv.getCanonicalDuration()).getStringValue());
    }

    @Test
    public void stringFormat3() throws XPathException {
        final DurationValue dv = new DayTimeDurationValue(null, "P0DT0H");
        assertEquals("PT0S", dv.getStringValue());
    }

    @Test
    public void stringFormat4() throws XPathException {
        final DurationValue dv = new DayTimeDurationValue(null, "PT5H0M0S");
        assertEquals("PT5H", dv.getStringValue());
    }

    @Test
    public void convert1() throws XPathException {
        final DayTimeDurationValue dtdv = new DayTimeDurationValue(null, "P3DT1H2M3S");
    ...
    public void getPart1() throws XPathException {
        final DurationValue dv = new DayTimeDurationValue(null, "P3DT4H5M6S");
    ...
    public void getValue1() throws XPathException {
        final DayTimeDurationValue dv = new DayTimeDurationValue(null, "P1DT30S");
        assertEquals(1.0 * 24 * 60 * 60 + 30.0, dv.getValue(), 0.0);
    }

    @Test
    public void getValue2() throws XPathException {
        final DayTimeDurationValue dv = new DayTimeDurationValue(null, "P1D");
    ...
    public void compare1() throws XPathException {
        ...
        final DurationValue dv2 = new DayTimeDurationValue(null, "P1DT2H3M5S");
    ...
    public void compare2() throws XPathException {
        final DurationValue dv1 = new DayTimeDurationValue(null, "P1DT2H3M4S");
        final DurationValue dv2 = new DayTimeDurationValue(null, "P1DT2H3M4S");
    ...
    public void compare5() throws XPathException {
        final DurationValue dv1 = new DayTimeDurationValue(null, "PT2H");
        final DurationValue dv2 = new DayTimeDurationValue(null, "PT2H0M");
        assertEquals(0, dv1.compareTo(null, dv2));
        assertEquals(0, dv2.compareTo(null, dv1));
    }
    ...
    public void plus1() throws XPathException {
        final DurationValue dv1 = new DayTimeDurationValue(null, "P2DT12H5M");
        final DurationValue dv2 = new DayTimeDurationValue(null, "P5DT12H");
        final DurationValue dv3 = new DayTimeDurationValue(null, "P8DT5M");
    ...
    public void minus1() throws XPathException {
        final DurationValue dv1 = new DayTimeDurationValue(null, "P2DT12H");
        final DurationValue dv2 = new DayTimeDurationValue(null, "P1DT10H30M");
        final DurationValue dv3 = new DayTimeDurationValue(null, "P1DT1H30M");
        assertDurationEquals(dv3, dv1.minus(dv2));
    }

    @Test
    public void mult1() throws XPathException {
        final DurationValue dv1 = new DayTimeDurationValue(null, "PT2H10M");
        final DecimalValue f = new DecimalValue(null, "2.1");
        final DurationValue dv2 = new DayTimeDurationValue(null, "PT4H33M");
    ...
    public void div1() throws XPathException {
        final DurationValue dv1 = new DayTimeDurationValue(null, "P1DT2H30M10.5S");
        final DecimalValue f = new DecimalValue(null, "1.5");
        final DurationValue dv2 = new DayTimeDurationValue(null, "PT17H40M7S");
        assertDurationEquals(dv2, dv1.div(f));
    }

    @Test
    public void div2() throws XPathException {
        final DurationValue dv1 = new DayTimeDurationValue(null, "P2DT53M11S");
        final DurationValue dv2 = new DayTimeDurationValue(null, "P1DT10H");
