...
public class TimeTest extends AbstractTimeRelatedTestCase {
    ...
    public void create1() throws XPathException {
        new TimeValue(null, "2005-10-11T10:00:00Z");
    }

    @Test(expected = XPathException.class)
    public void create2() throws XPathException {
        new TimeValue(null, "2005-10-11");
    }

    @Test
    public void stringFormat1() throws XPathException {
        final AbstractDateTimeValue v = new TimeValue(null, "10:00:00Z");
        assertEquals("10:00:00Z", v.getStringValue());
    }

    @Test
    public void stringFormat2() throws XPathException {
        final AbstractDateTimeValue v = new TimeValue(null, "10:00:00-01:00");
    ...
    public void stringFormat3() throws XPathException {
        final AbstractDateTimeValue v = new TimeValue(null, "24:00:00");
        assertEquals("00:00:00", v.getStringValue());
    }

    @Test
    public void stringFormat4() throws XPathException {
        final AbstractDateTimeValue v = new TimeValue(null, "10:00:00-00:00");
        assertEquals("10:00:00Z", v.getStringValue());
    }

    @Test
    public void stringFormat5() throws XPathException {
        final AbstractDateTimeValue v = new TimeValue(null, "10:00:00.5");
        assertEquals("10:00:00.5", v.getStringValue());
    }

    @Test
    public void stringFormat6() throws XPathException {
        final AbstractDateTimeValue v = new TimeValue(null, "10:00:00.50");
        assertEquals("10:00:00.5", v.getStringValue());
    }

    @Test
    public void stringFormat7() throws XPathException {
        final AbstractDateTimeValue v = new TimeValue(null, "10:00:00.0");
        assertEquals("10:00:00", v.getStringValue());
    }

    @Test
    public void stringFormat8() throws XPathException {
        final AbstractDateTimeValue v = new TimeValue(null, "10:00:00");
        assertEquals("10:00:00", v.getStringValue());
    }

    @Test
    public void getPart1() throws XPathException {
        final AbstractDateTimeValue v = new TimeValue(null, "10:05:02.6Z");
    ...
    public void getPart2() throws XPathException {
        final AbstractDateTimeValue v = new TimeValue(null, "10:05:02");
        assertEquals(10, v.getPart(AbstractDateTimeValue.HOUR));
        assertEquals(5, v.getPart(AbstractDateTimeValue.MINUTE));
        assertEquals(2, v.getPart(AbstractDateTimeValue.SECOND));
    }
    ...
    public void convert1() throws XPathException {
        final AbstractDateTimeValue v1 = new TimeValue(null, "10:05:02+05:00");
    ...
    public void convert2() throws XPathException {
        final AbstractDateTimeValue v1 = new TimeValue(null, "10:05:02");
        final AtomicValue v2 = v1.convertTo(Type.TIME);
        assertDateEquals(v1, v2);
    ...
    public void getTimezone2() throws XPathException {
        final AbstractDateTimeValue v1 = new TimeValue(null, "10:05:02+05:30");
    ...
    public void getTimezone4() throws XPathException {
        final AbstractDateTimeValue v1 = new TimeValue(null, "10:05:02Z");
    ...
    public void withoutTimezone1() throws XPathException {
        final AbstractDateTimeValue v1 = new TimeValue(null, "10:00:00");
        assertEquals("10:00:00", v1.withoutTimezone().toString());
    }

    @Test
    public void withoutTimezone2() throws XPathException {
        final AbstractDateTimeValue v1 = new TimeValue(null, "10:00:00-07:00");
        assertEquals("10:00:00", v1.withoutTimezone().toString());
    }
    ...
    public void adjustedToTimezone6() throws XPathException {
        final AbstractDateTimeValue v1 = new TimeValue(null, "00:00:00+01:00");
    ...
    public void adjustedToTimezone9() throws XPathException {
        final AbstractDateTimeValue v1 = new TimeValue(null, "00:00:00");
    ...
    public void compare1() throws XPathException {
        final AbstractDateTimeValue v1 = new TimeValue(null, "08:00:00+09:00");
        final AbstractDateTimeValue v2 = new TimeValue(null, "17:00:00-06:00");
    ...
    public void compare2() throws XPathException {
        final AbstractDateTimeValue v1 = new TimeValue(null, "21:30:00+10:30");
        final AbstractDateTimeValue v2 = new TimeValue(null, "06:00:00-05:00");
    ...
    public void compare3() throws XPathException {
        final AbstractDateTimeValue v1 = new TimeValue(null, "12:00:00");
        final AbstractDateTimeValue v2 = new TimeValue(null, "23:00:00+06:00");
        assertEquals(0, v1.compareTo(null, v2));
        assertEquals(0, v2.compareTo(null, v1));
    }
    ...
    public void compare4() throws XPathException {
        final AbstractDateTimeValue v1 = new TimeValue(null, "11:00:00");
        final AbstractDateTimeValue v2 = new TimeValue(null, "17:00:00Z");
        assertEquals(-1, v1.compareTo(null, v2));
        assertEquals(+1, v2.compareTo(null, v1));
    }
    ...
    public void plus1() throws XPathException {
        final AbstractDateTimeValue t = new TimeValue(null, "11:12:00");
        final DurationValue d = new DayTimeDurationValue(null, "P3DT1H15M");
        final AbstractDateTimeValue r = new TimeValue(null, "12:27:00");
        assertDateEquals(r, t.plus(d));
    }

    @Test
    public void plus2() throws XPathException {
        final AbstractDateTimeValue t = new TimeValue(null, "23:12:00+03:00");
        final DurationValue d = new DayTimeDurationValue(null, "P1DT3H15M");
        final AbstractDateTimeValue r = new TimeValue(null, "02:27:00+03:00");
        assertDateEquals(r, t.plus(d));
    }

    @Test
    public void minus1() throws XPathException {
        final AbstractDateTimeValue t1 = new TimeValue(null, "11:12:00Z");
        final AbstractDateTimeValue t2 = new TimeValue(null, "04:00:00");
        final DurationValue d = new DayTimeDurationValue(null, "PT2H12M");
        assertDurationEquals(d, t1.minus(t2));
    }

    @Test
    public void minus2() throws XPathException {
        final AbstractDateTimeValue t1 = new TimeValue(null, "11:00:00-05:00");
        final AbstractDateTimeValue t2 = new TimeValue(null, "21:30:00+05:30");
        final DurationValue d = new DayTimeDurationValue(null, "PT0S");
        assertDurationEquals(d, t1.minus(t2));
    }

    @Test
    public void minus3() throws XPathException {
        final AbstractDateTimeValue t1 = new TimeValue(null, "17:00:00-06:00");
        final AbstractDateTimeValue t2 = new TimeValue(null, "08:00:00+09:00");
        final DurationValue d = new DayTimeDurationValue(null, "P1D");
        assertDurationEquals(d, t1.minus(t2));
    }
    ...
    public void minus4() throws XPathException {
        final AbstractDateTimeValue t = new TimeValue(null, "11:12:00");
        final DurationValue d = new DayTimeDurationValue(null, "P3DT1H15M");
        final AbstractDateTimeValue r = new TimeValue(null, "09:57:00");
        assertDateEquals(r, t.minus(d));
    }

    @Test
    public void minus5() throws XPathException {
        final AbstractDateTimeValue t = new TimeValue(null, "08:20:00-05:00");
        final DurationValue d = new DayTimeDurationValue(null, "P23DT10H10M");
        final AbstractDateTimeValue r = new TimeValue(null, "22:10:00-05:00");
        assertDateEquals(r, t.minus(d));
    }
}
