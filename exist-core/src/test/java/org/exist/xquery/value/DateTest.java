...
public class DateTest extends AbstractTimeRelatedTestCase {
	...
	public void create1() throws XPathException {
		new DateValue(null, "2005-10-11T10:00:00Z");
	}

	@Test(expected = XPathException.class)
	public void create2() throws XPathException {
		new DateValue(null, "10:00:00Z");
	}

	@Test
	public void stringFormat1() throws XPathException {
		AbstractDateTimeValue v = new DateValue(null, "2005-10-11Z");
		assertEquals("2005-10-11Z", v.getStringValue());
	}

	@Test
	public void stringFormat2() throws XPathException {
		AbstractDateTimeValue v = new DateValue(null, "2005-10-11-01:00");
	...
	public void stringFormat3() throws XPathException {
		AbstractDateTimeValue v = new DateValue(null, "2005-10-11-00:00");
		assertEquals("2005-10-11Z", v.getStringValue());
	}

	@Test
	public void stringFormat4() throws XPathException {
		AbstractDateTimeValue v = new DateValue(null, "2005-10-11");
	...
	public void convert1() throws XPathException {
		AbstractDateTimeValue v1 = new DateValue(null, "2005-10-11+05:00");
	...
	public void convert2() throws XPathException {
		AbstractDateTimeValue v1 = new DateValue(null, "2005-10-11");
		AtomicValue v2 = v1.convertTo(Type.DATE);
		assertDateEquals(v1, v2);
	...
	public void convert3() throws XPathException {
		...
		assertDateEquals(new DateTimeValue(null, "2005-10-11T00:00:00+05:00"), v2);
	}
	...
	public void convert4() throws XPathException {
		AbstractDateTimeValue v1 = new DateValue(null, "2005-10-11");
		AtomicValue v2 = v1.convertTo(Type.DATE_TIME);
		assertDateEquals(new DateTimeValue(null, "2005-10-11T00:00:00"), v2);
		assertEquals(Sequence.EMPTY_SEQUENCE, ((AbstractDateTimeValue) v2).getTimezone());
	}
	...
	public void getTimezone2() throws XPathException {
		AbstractDateTimeValue v1 = new DateValue(null, "2005-10-11+05:30");
	...
	public void getTimezone4() throws XPathException {
		AbstractDateTimeValue v1 = new DateValue(null, "2005-10-11Z");
	...
	public void withoutTimezone1() throws XPathException {
		AbstractDateTimeValue v1 = new DateValue(null, "2002-03-07");
		assertEquals("2002-03-07", v1.withoutTimezone().toString());
	}

    @Test
	public void withoutTimezone2() throws XPathException {
		AbstractDateTimeValue v1 = new DateValue(null, "2002-03-07-07:00");
		assertEquals("2002-03-07", v1.withoutTimezone().toString());
	}
	...
	public void adjustedToTimezone3() throws XPathException {
		AbstractDateTimeValue v1 = new DateValue(null, "2002-03-07");
		AbstractDateTimeValue v2 = v1.adjustedToTimezone(new DayTimeDurationValue(null, "-PT10H"));
	...
	public void adjustedToTimezone5() throws XPathException {
        AbstractDateTimeValue v1 = new DateValue(null, "2002-03-07+01:00");
	...
	public void adjustedToTimezone8() throws XPathException {
		AbstractDateTimeValue v1 = new DateValue(null, "2002-03-07");
		AbstractDateTimeValue v2 = v1.adjustedToTimezone(new DayTimeDurationValue(null, "PT14H"));
	...
	public void compare1() throws XPathException {
		AbstractDateTimeValue v1 = new DateValue(null, "2004-12-25Z"), v2 = new DateValue(null, "2004-12-25+07:00");
	...
	public void compare2() throws XPathException {
		AbstractDateTimeValue v1 = new DateValue(null, "2004-12-25-12:00"), v2 = new DateValue(null, "2004-12-26+12:00");
	...
	public void compare3() throws XPathException {
		AbstractDateTimeValue v1 = new DateValue(null, "2004-12-25Z"), v2 = new DateValue(null, "2004-12-25-05:00");
		assertEquals(-1, v1.compareTo(null, v2));
		assertEquals(+1, v2.compareTo(null, v1));
	}
	...
	public void plus1() throws XPathException {
		AbstractDateTimeValue t = new DateValue(null, "2000-10-30");
		DurationValue d = new YearMonthDurationValue(null, "P1Y2M");
		AbstractDateTimeValue r = new DateValue(null, "2001-12-30");
		assertDateEquals(r, t.plus(d));
	}

    @Test
	public void plus2() throws XPathException {
		AbstractDateTimeValue t = new DateValue(null, "2000-10-30Z");
		DurationValue d = new YearMonthDurationValue(null, "P1Y2M");
		AbstractDateTimeValue r = new DateValue(null, "2001-12-30Z");
		assertDateEquals(r, t.plus(d));
	}

    @Test
	public void plus3() throws XPathException {
		AbstractDateTimeValue t = new DateValue(null, "2004-10-30");
		DurationValue d = new DayTimeDurationValue(null, "P2DT2H30M0S");
		AbstractDateTimeValue r = new DateValue(null, "2004-11-01");
		assertDateEquals(r, t.plus(d));
	}

    @Test
	public void plus4() throws XPathException {
		AbstractDateTimeValue t = new DateValue(null, "2004-10-30Z");
		DurationValue d = new DayTimeDurationValue(null, "P2DT2H30M0S");
		AbstractDateTimeValue r = new DateValue(null, "2004-11-01Z");
		assertDateEquals(r, t.plus(d));
	}

    @Test
	public void minus1() throws XPathException {
		AbstractDateTimeValue t1 = new DateValue(null, "2000-10-30");
		AbstractDateTimeValue t2 = new DateValue(null, "1999-11-28");
		DurationValue d = new DayTimeDurationValue(null, "P337D");
	...
	public void minus2() throws XPathException {
		AbstractDateTimeValue t = new DateValue(null, "2000-10-30");
		DurationValue d = new YearMonthDurationValue(null, "P1Y2M");
		AbstractDateTimeValue r = new DateValue(null, "1999-08-30");
		assertDateEquals(r, t.minus(d));
	}

    @Test
	public void minus3() throws XPathException {
		AbstractDateTimeValue t = new DateValue(null, "2000-02-29Z");
		DurationValue d = new YearMonthDurationValue(null, "P1Y");
		AbstractDateTimeValue r = new DateValue(null, "1999-02-28Z");
		assertDateEquals(r, t.minus(d));
	}

    @Test
	public void minus4() throws XPathException {
		AbstractDateTimeValue t = new DateValue(null, "2000-10-31-05:00");
		DurationValue d = new YearMonthDurationValue(null, "P1Y1M");
		AbstractDateTimeValue r = new DateValue(null, "1999-09-30-05:00");
		assertDateEquals(r, t.minus(d));
	}
	...
	public void minus5() throws XPathException {
		AbstractDateTimeValue t = new DateValue(null, "2000-10-30");
		DurationValue d = new DayTimeDurationValue(null, "P3DT1H15M");
		AbstractDateTimeValue r = new DateValue(null, "2000-10-26");
		assertDateEquals(r, t.minus(d));
	}

    @Test
	public void minus6() throws XPathException {
		DateValue d1 = new DateValue(null, "2005-10-11"), d2 = new DateValue(null, "2005-10-09");
	...
	public void minus7() throws XPathException {
		DateValue d1 = new DateValue(null, "2005-10-10"), d2 = new DateValue(null, "2005-10-09");
		DayTimeDurationValue r = (DayTimeDurationValue) d1.minus(d2);
	...
	public void equal() throws XPathException {
        assertEquals(new DateValue(null, "2010-06-01+05:00"), new DateValue(null, "2010-06-01+05:00"));
	}
}
