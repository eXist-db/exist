...
public class LongTest {
    ...
    public void testOver() throws XPathException {
        new IntegerValue(null, "9223372036854775808", Type.LONG);
    }
    
    @Test
    public void testPositiveLimit() throws XPathException {
        new IntegerValue(null, "9223372036854775807", Type.LONG);
    }
    ...
    public void testUnder() throws XPathException {
        new IntegerValue(null, "-9223372036854775809", Type.LONG);
    }   
}
