...
public class XQueryTriggerSetUidTest {
	...
	private static final XmldbURI TEST_COLLECTION_URI = XmldbURI.create("/db/testXQueryTriggerSetUid");
    ...
    private static final XmldbURI TRIGGER_MODULE_URI = TEST_COLLECTION_URI.append("XQueryTriggerSetUid.xqm");
