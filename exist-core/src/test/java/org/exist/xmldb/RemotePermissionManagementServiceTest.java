...
class RemotePermissionManagementServiceTest {
    @Mock
    EXistUserManagementService userManagementService;
    RemotePermissionManagementService service;
    ...
    void setUp() throws XMLDBException {
        ...
        service = new RemotePermissionManagementService(collection);
    }
    ...
    void getPermissionsForResource() throws XMLDBException {
        ...
        verify(userManagementService, res, perm);
    }
