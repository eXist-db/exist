...
class LocalUserPrincipalLookupServiceTest {
    @Mock
    EXistUserManagementService userManagementService;
    LocalUserPrincipalLookupService service;
    ...
    void setUp() throws XMLDBException {
        ...
        service = new LocalUserPrincipalLookupService(user, brokerPool, collection);
    }
