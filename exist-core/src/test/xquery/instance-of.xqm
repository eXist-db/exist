...
declare
    %test:assertEquals("false", "false", "true", "false", "true")
function io:decimal() {
...
declare
    %test:assertEquals("false", "false", "true", "true", "true")
function io:integer() {
...
function io:numeric-decimal() {
  ...
  xs:numeric(1.0) instance of xs:decimal,             (: NOTE(AR) for an explanation of why this is true, see: https://xmlcom.slack.com/archives/C011NLXE4DU/p1676291235309039 :)
...
declare
    %test:pending("eXist-db does not yet correctly infer that xs:numeric(1) is the same as xs:integer(1)")
...
function io:numeric-integer() {
  ...
  xs:numeric(1) instance of xs:nonPositiveInteger
};
