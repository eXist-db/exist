...
public class RemotePermissionManagementService extends AbstractRemoteService implements PermissionManagementService {
    public RemotePermissionManagementService(RemoteCollection collection) {
        super(collection);
    }
