...
public class LocalUserPrincipalLookupService extends AbstractLocalService implements UserPrincipalLookupService {
    private EXistUserManagementService userManagementService;

    LocalUserPrincipalLookupService(Subject user, BrokerPool brokerPool, LocalCollection collection) {
