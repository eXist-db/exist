...
public class VariableByteOutputStream extends OutputStream {
     ...
     *
     * 1. org.exist.util.io.UnsynchronizedByteArrayOutputStream which is based on Apache Commons IO org.apache.commons.io.ByteArrayOutputStream
     ...
     *
     * 2. it.unimi.dsi.fastutil.io.UnsynchronizedByteArrayOutputStream which allocates a single underlying buffer, appends that
