...
public class Dependency {
	 ...
	 */
	public static final int VARS = LOCAL_VARS + CONTEXT_VARS;
	 ...
	 */
	public static final int DEFAULT_DEPENDENCIES = CONTEXT_SET;
	
	public static String getDependenciesName(int dependencies) {
    ...
    public static boolean dependsOn(Expression expr, int dependency) {
        return (expr.getDependencies()& dependency) == dependency;
    }

    public static boolean dependsOn(int expressionDep, int dependency) {
        return (expressionDep & dependency) == dependency;
    }

    public static boolean dependsOnVar(Expression expr) {
