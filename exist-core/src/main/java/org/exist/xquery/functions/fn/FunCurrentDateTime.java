...
public class FunCurrentDateTime extends Function {
    ...
    public static final FunctionSignature fnCurrentDateTime =
    ...
    public static final FunctionSignature fnCurrentTime =
        new FunctionSignature(
    ...
    public static final FunctionSignature fnCurrentDate =
        new FunctionSignature(
