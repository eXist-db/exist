...
public class FunStrLength extends Function {
    ...
    public final static FunctionSignature[] signatures = {
            ...
            new FunctionSignature(
                    ...
                    new SequenceType[]{
                            new FunctionParameterSequenceType("value", Type.STRING, Cardinality.ZERO_OR_ONE, "The input string")
                    },
                    new FunctionReturnSequenceType(Type.INTEGER, Cardinality.EXACTLY_ONE, "the length in characters")
            )
    };
    ...
    public Sequence eval(Sequence contextSequence, final Item contextItem) throws XPathException {
        ...
        final Sequence result = new IntegerValue(this, FunStringToCodepoints.getCodePointCount(strval));
