...
public class FunNumber extends Function {
    ...
    protected static final FunctionParameterSequenceType ARG_PARAM = new FunctionParameterSequenceType("value", Type.ANY_ATOMIC_TYPE, Cardinality.ZERO_OR_ONE, "The input item");
