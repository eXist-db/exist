...
public class OneParamFunctions extends BasicFunction {
    ...
    public static final FunctionSignature FNS_ACOS = new FunctionSignature(
    ...
    public static final FunctionSignature FNS_ASIN = new FunctionSignature(
    ...
    public static final FunctionSignature FNS_ATAN = new FunctionSignature(
    ...
    public static final FunctionSignature FNS_COS = new FunctionSignature(
    ...
    public static final FunctionSignature FNS_EXP = new FunctionSignature(
    ...
    public static final FunctionSignature FNS_EXP10 = new FunctionSignature( // NEW
    ...
    public static final FunctionSignature FNS_LOG = new FunctionSignature(
    ...
    public static final FunctionSignature FNS_LOG10 = new FunctionSignature( // NEW
    ...
    public static final FunctionSignature FNS_SIN = new FunctionSignature(
    ...
    public static final FunctionSignature FNS_SQRT = new FunctionSignature(
    ...
    public static final FunctionSignature FNS_TAN = new FunctionSignature(
