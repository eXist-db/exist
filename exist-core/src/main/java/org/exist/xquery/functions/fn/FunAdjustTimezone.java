...
public class FunAdjustTimezone extends BasicFunction {
    ...
    public final static FunctionParameterSequenceType DATE_TIME_01_PARAM = new FunctionParameterSequenceType("value", Type.DATE_TIME, Cardinality.ZERO_OR_ONE, "The date-time");
    public final static FunctionParameterSequenceType DATE_01_PARAM = new FunctionParameterSequenceType("value", Type.DATE, Cardinality.ZERO_OR_ONE, "The date");
    public final static FunctionParameterSequenceType TIME_01_PARAM = new FunctionParameterSequenceType("value", Type.TIME, Cardinality.ZERO_OR_ONE, "The time");
    public final static FunctionParameterSequenceType DURATION_01_PARAM = new FunctionParameterSequenceType("timezone", Type.DAY_TIME_DURATION, Cardinality.ZERO_OR_ONE, "The duration");
