...
public class ArrayModule extends AbstractInternalModule {
    ...
    private static final FunctionDef[] functions = functionDefs(
            functionDefs(
                    ...
                    ArrayFunction.TRUNK,
                    ArrayFunction.ITEMS,
                    ArrayFunction.MEMBERS
            ),
            functionDefs(
                    ArraySlice.class,
                    ArraySlice.signatures
            ),
            functionDefs(
                    ArrayIndexWhere.class,
                    ArrayIndexWhere.signatures
            ),
            functionDefs(
                    ArraySortWith.class,
                    ArraySortWith.signatures
            ),
            functionDefs(
                    ArraySortBy.class,
                    ArraySortBy.signatures
            ),
            functionDefs(
                    ArrayBuild.class,
                    ArrayBuild.signatures
            ),
            functionDefs(
                    ArrayIndexOf.class,
                    ArrayIndexOf.signatures
            ),
            functionDefs(
                    ArrayOfMembers.class,
                    ArrayOfMembers.signatures
            ),
            functionDefs(
                    ArraySplit.class,
                    ArraySplit.signatures
            )
    );
