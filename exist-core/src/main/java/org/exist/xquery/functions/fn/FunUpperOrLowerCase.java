...
public class FunUpperOrLowerCase extends Function {
	...
	public final static FunctionSignature fnUpperCase =
		new FunctionSignature(
			...
			new SequenceType[] { new FunctionParameterSequenceType("value", Type.STRING, Cardinality.ZERO_OR_ONE, "The text to be converted to all upper-case characters") },
	...
	public final static FunctionSignature fnLowerCase =
		new FunctionSignature(
			...
			new SequenceType[] { new FunctionParameterSequenceType("value", Type.STRING, Cardinality.ZERO_OR_ONE, "The text to be converted to all lower-case characters") },
