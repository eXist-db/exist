...
public class FunIndexOf extends BasicFunction {
	...
	protected static final FunctionParameterSequenceType COLLATION_PARAM = new FunctionParameterSequenceType("collation", Type.STRING, Cardinality.EXACTLY_ONE, "The collation URI");

	protected static final FunctionParameterSequenceType SEARCH_PARAM = new FunctionParameterSequenceType("target", Type.ANY_ATOMIC_TYPE, Cardinality.EXACTLY_ONE, "The search component");

	protected static final FunctionParameterSequenceType SEQ_PARAM = new FunctionParameterSequenceType("input", Type.ANY_ATOMIC_TYPE, Cardinality.ZERO_OR_MORE, "The source sequence");
