...
public abstract class AbstractMapType extends FunctionReference
    ...
    protected static boolean sameKey(@Nullable final Collator collator, final AtomicValue k1, final AtomicValue k2) {
        ...
        try {
            ...
            // fn:deep-equal($k1, $k2)
            if ((k1Type == Type.DATE || k1Type == Type.TIME || Type.subTypeOf(k1Type, Type.DATE_TIME) || k1Type == Type.GYEAR || k1Type == Type.GYEARMONTH || k1Type == Type.GMONTH || k1Type == Type.GMONTHDAY || k1Type == Type.GDAY)
                    && (k2Type == Type.DATE || k2Type == Type.TIME || Type.subTypeOf(k2Type, Type.DATE_TIME) || k2Type == Type.GYEAR || k2Type == Type.GYEARMONTH || k2Type == Type.GMONTH || k2Type == Type.GMONTHDAY || k2Type == Type.GDAY)
