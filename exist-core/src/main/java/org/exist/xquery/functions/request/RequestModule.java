...
public class RequestModule extends AbstractInternalModule {
    ...
    public static final FunctionDef[] functions = {
            ...
            new FunctionDef(NegotiateContentType.signatures[0], NegotiateContentType.class),
            new FunctionDef(NegotiateContentType.signatures[1], NegotiateContentType.class),
            new FunctionDef(ParseAcceptHeader.signature, ParseAcceptHeader.class),
    ...
    public static final class Factory implements org.exist.xquery.ModuleFactory {
        ...
        @Override public Class<? extends org.exist.xquery.Module> getModuleClass() { return RequestModule.class; }
    }
}
