...
public class GYearValue extends AbstractDateTimeValue {
    ...
    public GYearValue(final Expression expression, String timeValue) throws XPathException {
        ...
        try {
            ...
            throw new XPathException(getExpression(), ErrorCodes.FORG0001, "xs:gYear instance must not have month, day, hour, minute or second fields set");
        }
    }
        ...
        switch (requiredType) {
            ...
            default:
                throw new XPathException(getExpression(), ErrorCodes.XPTY0004,
                        "Type error: cannot cast xs:gYear to "
