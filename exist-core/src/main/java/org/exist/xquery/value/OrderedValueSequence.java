...
//		FastQSort.sort(items, 0, count - 1);
    ...
    private static class Entry implements Comparable<Entry> {
         ...
         */
        public static Entry create(final List<OrderSpec> orderSpecs, final Item item, final int position, @Nullable final Sequence contextSequence) throws XPathException {
            ...
            for (final OrderSpec orderSpec : orderSpecs) {
                ...
                final Sequence seq = sortExpression.eval(contextSequence);
                if (seq.hasOne()) {
