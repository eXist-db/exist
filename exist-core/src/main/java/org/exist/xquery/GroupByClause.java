...
public class GroupByClause extends AbstractFLWORClause {
    ...
    public Sequence eval(Sequence contextSequence, Item contextItem) throws XPathException {
        ...
        for (final GroupSpec spec: groupSpecs) {
            ...
            final SequenceType groupingVarType = spec.getKeyVarType() != null ? spec.getKeyVarType() : new SequenceType(Type.ATOMIC, groupingValue.isEmpty() ? Cardinality.EMPTY_SEQUENCE : Cardinality.EXACTLY_ONE);
