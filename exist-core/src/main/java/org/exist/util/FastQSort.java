...
public final class FastQSort {
	...
	private static <C extends Comparable<? super C>> void IntroSort(C[] a, int lo, int hi)
	{
		IntroSortLoop(a,lo,hi,2*(int)Math.floor(Math.log(hi-lo+1)/LOG2));
		InsertionSort.sort(a,lo,hi);
	}

	private static <C extends Comparable<? super C>> void IntroSort(C[] a, int lo, int hi, int[] b)
	{
		IntroSortLoop(a,lo,hi,b,2*(int)Math.floor(Math.log(hi-lo+1)/LOG2));
		InsertionSort.sort(a,lo,hi,b);
	}
	
	private static <C> void IntroSort(C[] a, Comparator<C> comp, int lo, int hi)
	{
		IntroSortLoop(a,comp,lo,hi,2*(int)Math.floor(Math.log(hi-lo+1)/LOG2));
		InsertionSort.sort(a,comp,lo,hi);
	}
	
	private static <C extends Comparable<? super C>> void introSort(List<C> a, int lo, int hi)
	{
		introSortLoop(a,lo,hi,2*(int)Math.floor(Math.log(hi-lo+1)/LOG2));
		InsertionSort.sort(a,lo,hi);
	}
	
	private static void introSort(long[] a, int lo, int hi, Object[] b)
	{
		introSortLoop(a,lo,hi,b,2*(int)Math.floor(Math.log(hi-lo+1)/LOG2));
		InsertionSort.sort(a,lo,hi,b);
	}
	
	private static void introSortByNodeId(NodeProxy[] a, int lo, int hi)
	{
		introSortLoopByNodeId(a,lo,hi,2*(int)Math.floor(Math.log(hi-lo+1)/LOG2));
		InsertionSort.sortByNodeId(a,lo,hi);
	}
	
	private static <C extends Comparable<? super C>> void IntroSortLoop(C[] a, int l, int r, int maxdepth)
	//----------------------------------------------------
	{
		while ( (r - l) > M ) {
			if(maxdepth<=0) {
	...
	private static <C extends Comparable<? super C>> void IntroSortLoop(C[] a, int l, int r, int[] b, int maxdepth)
	//----------------------------------------------------
	{
		while ( (r - l) > M ) {
			if(maxdepth<=0) {
	...
	private static <C> void IntroSortLoop(C[] a, Comparator<C> comp, int l, int r, int maxdepth)
	//----------------------------------------------------
	{
		while ( (r - l) > M ) {
			if(maxdepth<=0) {
	...
	private static <C extends Comparable<? super C>> void introSortLoop(List<C> a, int l, int r, int maxdepth)
	//----------------------------------------------------
	{
		while ( (r - l) > M ) {
			if(maxdepth<=0) {
	...
	private static void introSortLoop(long[] a, int l, int r, Object[] b, int maxdepth)
	//----------------------------------------------------
	{
		while ( (r - l) > M ) {
			if(maxdepth<=0) {
	...
	private static void introSortLoopByNodeId(NodeProxy[] a, int l, int r, int maxdepth)
	//----------------------------------------------------
	{
		while ( (r - l) > M ) {
			if(maxdepth<=0) {
