...
/**
 * Utility methods which help when the values
 * of two positions in an array or list-like
 * structure must be swapped.
 *
 * Based on previous implementations found in
 * eXist FastQSort original code and internet.
 */
