/*
 * This code has been contributed to the Apache Commons IO project
 * by Adam Retter.
 *
 * After it is merged and released, use of this class should be replaced
 * with org.apache.commons.io.input.MarkShieldInputStream
 *
 * ----------------------------------------------------------------------------
 *
