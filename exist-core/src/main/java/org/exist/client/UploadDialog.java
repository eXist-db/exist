...
class UploadDialog extends JFrame {
    ...
    public void setCurrentSize(long size) {
        if (size >= 1024) {
            currentSize.setText(size / 1024 + Messages.getString("UploadDialog.12"));
        } //$NON-NLS-1$
        else {
    ...
    class UploadProgressObserver implements Observer {
        ...
        public void update(Observable o, Object arg) {
            ...
            if (o instanceof ElementIndex) {
                progress.setString(Messages.getString("UploadDialog.18"));
            } //$NON-NLS-1$
            else {
                progress.setString(Messages.getString("UploadDialog.19"));
            } //$NON-NLS-1$
        }
