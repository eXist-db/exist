...
import org.exist.xpath.functions.transform.ModuleImpl;
...
public class XQueryContext {
	...
	public void importModule(String namespaceURI, String prefix, String location)
		...
		if(location.indexOf(':') < 0) {
			...
			if(!f.canRead())
				throw new XPathException("cannot read module source from file at " + location);
		...
		XPathLexer2 lexer = new XPathLexer2(reader);
	...
	private void loadDefaults() {
		...
		loadBuiltInModule(
			...
			"org.exist.xpath.functions.ModuleImpl");
		loadBuiltInModule(
			Function.UTIL_FUNCTION_NS,
			"org.exist.xpath.functions.util.ModuleImpl");
		loadBuiltInModule(ModuleImpl.NAMESPACE_URI,
			"org.exist.xpath.functions.transform.ModuleImpl");
		loadBuiltInModule(
			Function.XMLDB_FUNCTION_NS,
			"org.exist.xpath.functions.xmldb.ModuleImpl");
		loadBuiltInModule(
			Function.REQUEST_FUNCTION_NS,
			"org.exist.xpath.functions.request.RequestModule");
	}
}
