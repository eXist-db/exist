...
public class OpEquals extends BinaryOp {
     ...
     *@param  relation  Description of the Parameter
     */
    public OpEquals( BrokerPool pool, Expression left,
                     Expression right, int relation ) {
        super(pool);
        this.relation = relation;
     ...
     */
    protected Value booleanCompare( Expression left, Expression right, DocumentSet docs,
     ...
     *@return          Description of the Return Value
     */
    protected Value nodeSetCompare( Expression left, Expression right, DocumentSet docs,
                                    NodeSet context, NodeProxy node ) {
     ...
     *@return          Description of the Return Value
     */
    protected Value numberCompare( Expression left, Expression right, DocumentSet docs,
                                   NodeSet context, NodeProxy node ) {
        ArraySet result = new ArraySet( 100 );
        NodeProxy n;
        double rvalue;
...
//		} else
     ...
     *@return          Description of the Return Value
     */
    protected Value stringCompare( Expression left, Expression right, DocumentSet docs,
                                   NodeSet context, NodeProxy node ) {
        ArraySet result = new ArraySet( 100 );
        NodeProxy n;
        String lvalue;
