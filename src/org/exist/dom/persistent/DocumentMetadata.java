...
public class DocumentMetadata {
    ...
    public void write(final SymbolTable st, final VariableByteOutputStream ostream) throws IOException {
        ostream.writeLong(created);
        ostream.writeLong(lastModified);
        ostream.writeInt(st.getMimeTypeId(mimeType));
    ...
    public void read(final SymbolTable st, final VariableByteInput istream) throws IOException {
        created = istream.readLong();
        lastModified = istream.readLong();
        final int mimeTypeSymbolsIndex = istream.readInt();
        mimeType = st.getMimeType(mimeTypeSymbolsIndex);
