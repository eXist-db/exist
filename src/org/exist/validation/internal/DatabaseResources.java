...
public class DatabaseResources {
    ...
    public Sequence executeQuery(String queryPath, Map<String,String> params, UserImpl user){
    ...
    public String findXSD(String collection, String targetNamespace, UserImpl user){
    ...
    public String findCatalogWithDTD(String collection, String publicId, UserImpl user){
