...
public class ChildSelector implements NodeSelector {
	...
	public NodeProxy match(NodeProxy proxy) {
		...
		case Node.ATTRIBUTE_NODE :
			//Attention : an attribute is a child from eXist's point of view
			break;
		case Node.TEXT_NODE :
			//TODO : treat as attributes ?
			return null;
        ...
        if(p == null) 
            return null;         
        NodeProxy contextNode = context.parentWithChild(proxy.getDocument(), proxy.getGID(), true, false, NodeProxy.UNKNOWN_NODE_LEVEL);  
		if (contextNode == null)
           return null;
