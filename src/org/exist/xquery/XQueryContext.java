...
//	private LockedDocumentMap lockedDocuments = null;
	...
	public void prepare()
	{
		...
		UserImpl user = getUserFromHttpSession();
		if(user != null)
		{
            broker.setUser(user);
        }
...
//			throw new XPathException("XQST0034: function " + function.getName() + " is already defined with the same arity");
	 ...
	 */
	private UserImpl getUserFromHttpSession()
	{
		...
		if(var != null && var.getValue() != null)
		{
    		if(var.getValue().getItemType() == Type.JAVA_OBJECT)
    		{
        		...
        		{
                    try {
                        return (UserImpl)((SessionWrapper)session.getObject()).getAttribute(HTTP_SESSIONVAR_XMLDB_USER);
