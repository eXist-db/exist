...
public class XMLDBModule extends AbstractInternalModule {
	...
	public final static FunctionDef[] functions = {
        ...
        new FunctionDef(XMLDBExistsUser.fnExistsUser, XMLDBExistsUser.class),
        new FunctionDef(XMLDBExistsUser.fnUserGroups, XMLDBExistsUser.class),
        new FunctionDef(XMLDBExistsUser.fnUserHome, XMLDBExistsUser.class),
