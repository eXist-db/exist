...
public class FnModule extends AbstractInternalModule {
    ...
    public final static FunctionDef[] functions = {
        ...
        new FunctionDef(FnFormatDates.signatures[0], FnFormatDates.class),
        new FunctionDef(FnFormatDates.signatures[1], FnFormatDates.class),
        new FunctionDef(FnFormatDates.signatures[2], FnFormatDates.class),
