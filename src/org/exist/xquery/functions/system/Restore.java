...
public class Restore extends BasicFunction {
   ...
   public Sequence eval(Sequence[] args, Sequence contextSequence) throws XPathException {
      ...
      try {
         org.exist.backup.Restore restore = new org.exist.backup.Restore(org.exist.security.SecurityManager.DBA_USER,
                 adminPass, adminPassAfter, new File(dirOrFile), XmldbURI.EMBEDDED_SERVER_URI.toString());
