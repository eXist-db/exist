 ...
 */
public class FunGetMinutesFromDayTimeDuration extends Function {

	public final static FunctionSignature signature =
		new FunctionSignature(
			new QName("get-minutes-from-dayTimeDuration", BUILTIN_FUNCTION_NS),
	 ...
	 * @param signature
	 */
	public FunGetMinutesFromDayTimeDuration(XQueryContext context) {
