 ...
 */
public class RequestURL extends BasicFunction {

	public final static FunctionSignature signature =
		new FunctionSignature(
			new QName("request-url", RequestModule.NAMESPACE_URI, RequestModule.PREFIX),
	 ...
	 * @param signature
	 */
	public RequestURL(XQueryContext context) {
