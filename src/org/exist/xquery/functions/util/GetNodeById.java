...
public class GetNodeById extends BasicFunction {
	...
	public final static FunctionSignature signature =
		new FunctionSignature(
			...
			"the internal node-id, specified as a long number. Please note: the function does " +
	...
	public Sequence eval(Sequence[] args, Sequence contextSequence)
		...
		long gid = ((IntegerValue)args[1].itemAt(0)).getLong();
		NodeProxy node = new NodeProxy(doc, gid);
		return node;
	}
}
