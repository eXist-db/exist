...
public class FunAdjustDateTimeToTimezone extends BasicFunction {
	...
	public final static FunctionSignature fnAdjustDateTimeToTimezone[] = {
			new FunctionSignature(
				new QName("adjust-dateTime-to-timezone", Module.BUILTIN_FUNCTION_NS),
	 ...
	 * @param signature
	 */
	public FunAdjustDateTimeToTimezone(XQueryContext context,
	...
	public Sequence eval(Sequence[] args, Sequence contextSequence)
		...
		DateTimeValue time = (DateTimeValue) args[0].itemAt(0);
		int tzOffset;
