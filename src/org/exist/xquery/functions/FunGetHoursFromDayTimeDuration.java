 ...
 */
public class FunGetHoursFromDayTimeDuration extends Function {

	public final static FunctionSignature signature =
		new FunctionSignature(
			new QName("hours-from-duration", Module.BUILTIN_FUNCTION_NS),
	 ...
	 * @param signature
	 */
	public FunGetHoursFromDayTimeDuration(XQueryContext context) {
