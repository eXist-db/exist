...
public interface DeclScannerTokenTypes {
	...
	int END_TAG_START = 189;
	int QUOT = 190;
	int APOS = 191;
	int QUOT_ATTRIBUTE_CONTENT = 192;
	int ESCAPE_QUOT = 193;
	int APOS_ATTRIBUTE_CONTENT = 194;
	int ESCAPE_APOS = 195;
	int ELEMENT_CONTENT = 196;
	int XML_COMMENT_END = 197;
	int XML_PI_END = 198;
	int XML_CDATA = 199;
	int LITERAL_collection = 200;
	int LITERAL_validate = 201;
	int XML_PI_START = 202;
	int XML_CDATA_START = 203;
	int XML_CDATA_END = 204;
	int LETTER = 205;
	int DIGITS = 206;
	int HEX_DIGITS = 207;
	int NMSTART = 208;
	int NMCHAR = 209;
	int WS = 210;
	int EXPR_COMMENT = 211;
	int PREDEFINED_ENTITY_REF = 212;
	int CHAR_REF = 213;
	int S = 214;
	int NEXT_TOKEN = 215;
	int CHAR = 216;
