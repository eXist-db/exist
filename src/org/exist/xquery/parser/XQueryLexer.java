...
public XQueryLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("treat", this), Integer.valueOf(154));
	literals.put(new ANTLRHashString("typeswitch", this), Integer.valueOf(125));
	literals.put(new ANTLRHashString("copy-namespaces", this), Integer.valueOf(81));
	literals.put(new ANTLRHashString("xpointer", this), Integer.valueOf(64));
	literals.put(new ANTLRHashString("namespace", this), Integer.valueOf(72));
	literals.put(new ANTLRHashString("no-preserve", this), Integer.valueOf(99));
	literals.put(new ANTLRHashString("comment", this), Integer.valueOf(188));
	literals.put(new ANTLRHashString("case", this), Integer.valueOf(147));
	literals.put(new ANTLRHashString("option", this), Integer.valueOf(82));
	literals.put(new ANTLRHashString("delete", this), Integer.valueOf(130));
	literals.put(new ANTLRHashString("ne", this), Integer.valueOf(160));
	literals.put(new ANTLRHashString("validate", this), Integer.valueOf(225));
	literals.put(new ANTLRHashString("le", this), Integer.valueOf(162));
	literals.put(new ANTLRHashString("greatest", this), Integer.valueOf(92));
	literals.put(new ANTLRHashString("ancestor-or-self", this), Integer.valueOf(207));
	literals.put(new ANTLRHashString("descendant-or-self", this), Integer.valueOf(203));
	literals.put(new ANTLRHashString("insert", this), Integer.valueOf(129));
	literals.put(new ANTLRHashString("variable", this), Integer.valueOf(84));
	literals.put(new ANTLRHashString("where", this), Integer.valueOf(138));
	literals.put(new ANTLRHashString("stable", this), Integer.valueOf(142));
	literals.put(new ANTLRHashString("construction", this), Integer.valueOf(79));
	literals.put(new ANTLRHashString("then", this), Integer.valueOf(148));
	literals.put(new ANTLRHashString("preceding", this), Integer.valueOf(134));
	literals.put(new ANTLRHashString("document-node", this), Integer.valueOf(190));
	literals.put(new ANTLRHashString("collation", this), Integer.valueOf(88));
	literals.put(new ANTLRHashString("to", this), Integer.valueOf(172));
	literals.put(new ANTLRHashString("and", this), Integer.valueOf(151));
	literals.put(new ANTLRHashString("module", this), Integer.valueOf(71));
	literals.put(new ANTLRHashString("strip", this), Integer.valueOf(95));
	literals.put(new ANTLRHashString("return", this), Integer.valueOf(139));
	literals.put(new ANTLRHashString("inherit", this), Integer.valueOf(100));
	literals.put(new ANTLRHashString("schema", this), Integer.valueOf(107));
	literals.put(new ANTLRHashString("external", this), Integer.valueOf(106));
	literals.put(new ANTLRHashString("unordered", this), Integer.valueOf(97));
	literals.put(new ANTLRHashString("ordered", this), Integer.valueOf(96));
	literals.put(new ANTLRHashString("mod", this), Integer.valueOf(176));
	literals.put(new ANTLRHashString("following", this), Integer.valueOf(135));
	literals.put(new ANTLRHashString("except", this), Integer.valueOf(182));
	literals.put(new ANTLRHashString("text", this), Integer.valueOf(185));
	literals.put(new ANTLRHashString("preserve", this), Integer.valueOf(94));
	literals.put(new ANTLRHashString("function", this), Integer.valueOf(83));
	literals.put(new ANTLRHashString("with", this), Integer.valueOf(132));
	literals.put(new ANTLRHashString("gt", this), Integer.valueOf(163));
	literals.put(new ANTLRHashString("preceding-sibling", this), Integer.valueOf(208));
	literals.put(new ANTLRHashString("intersect", this), Integer.valueOf(181));
	literals.put(new ANTLRHashString("version", this), Integer.valueOf(69));
	literals.put(new ANTLRHashString("map", this), Integer.valueOf(116));
	literals.put(new ANTLRHashString("at", this), Integer.valueOf(110));
	literals.put(new ANTLRHashString("of", this), Integer.valueOf(153));
	literals.put(new ANTLRHashString("is", this), Integer.valueOf(169));
	literals.put(new ANTLRHashString("array", this), Integer.valueOf(117));
	literals.put(new ANTLRHashString("empty-sequence", this), Integer.valueOf(111));
	literals.put(new ANTLRHashString("or", this), Integer.valueOf(150));
	literals.put(new ANTLRHashString("if", this), Integer.valueOf(123));
	literals.put(new ANTLRHashString("least", this), Integer.valueOf(93));
	literals.put(new ANTLRHashString("as", this), Integer.valueOf(109));
	literals.put(new ANTLRHashString("by", this), Integer.valueOf(141));
	literals.put(new ANTLRHashString("catch", this), Integer.valueOf(136));
	literals.put(new ANTLRHashString("union", this), Integer.valueOf(180));
	literals.put(new ANTLRHashString("try", this), Integer.valueOf(120));
	literals.put(new ANTLRHashString("order", this), Integer.valueOf(90));
	literals.put(new ANTLRHashString("xquery", this), Integer.valueOf(68));
	literals.put(new ANTLRHashString("following-sibling", this), Integer.valueOf(204));
	literals.put(new ANTLRHashString("node", this), Integer.valueOf(186));
	literals.put(new ANTLRHashString("collection", this), Integer.valueOf(224));
	literals.put(new ANTLRHashString("some", this), Integer.valueOf(121));
	literals.put(new ANTLRHashString("ge", this), Integer.valueOf(164));
	literals.put(new ANTLRHashString("declare", this), Integer.valueOf(75));
	literals.put(new ANTLRHashString("for", this), Integer.valueOf(118));
	literals.put(new ANTLRHashString("ascending", this), Integer.valueOf(143));
	literals.put(new ANTLRHashString("isnot", this), Integer.valueOf(170));
	literals.put(new ANTLRHashString("eq", this), Integer.valueOf(159));
	literals.put(new ANTLRHashString("element", this), Integer.valueOf(89));
	literals.put(new ANTLRHashString("default", this), Integer.valueOf(76));
	literals.put(new ANTLRHashString("castable", this), Integer.valueOf(155));
	literals.put(new ANTLRHashString("descending", this), Integer.valueOf(144));
	literals.put(new ANTLRHashString("idiv", this), Integer.valueOf(175));
	literals.put(new ANTLRHashString("boundary-space", this), Integer.valueOf(77));
	literals.put(new ANTLRHashString("ancestor", this), Integer.valueOf(206));
	literals.put(new ANTLRHashString("ordering", this), Integer.valueOf(78));
	literals.put(new ANTLRHashString("instance", this), Integer.valueOf(152));
	literals.put(new ANTLRHashString("replace", this), Integer.valueOf(127));
	literals.put(new ANTLRHashString("no-inherit", this), Integer.valueOf(101));
	literals.put(new ANTLRHashString("attribute", this), Integer.valueOf(187));
	literals.put(new ANTLRHashString("empty", this), Integer.valueOf(91));
	literals.put(new ANTLRHashString("cast", this), Integer.valueOf(156));
	literals.put(new ANTLRHashString("value", this), Integer.valueOf(128));
	literals.put(new ANTLRHashString("encoding", this), Integer.valueOf(87));
	literals.put(new ANTLRHashString("schema-element", this), Integer.valueOf(212));
	literals.put(new ANTLRHashString("into", this), Integer.valueOf(133));
	literals.put(new ANTLRHashString("rename", this), Integer.valueOf(131));
	literals.put(new ANTLRHashString("else", this), Integer.valueOf(149));
	literals.put(new ANTLRHashString("import", this), Integer.valueOf(86));
	literals.put(new ANTLRHashString("lt", this), Integer.valueOf(161));
	literals.put(new ANTLRHashString("document", this), Integer.valueOf(191));
	literals.put(new ANTLRHashString("self", this), Integer.valueOf(201));
	literals.put(new ANTLRHashString("in", this), Integer.valueOf(140));
	literals.put(new ANTLRHashString("let", this), Integer.valueOf(119));
	literals.put(new ANTLRHashString("base-uri", this), Integer.valueOf(80));
	literals.put(new ANTLRHashString("processing-instruction", this), Integer.valueOf(189));
	literals.put(new ANTLRHashString("parent", this), Integer.valueOf(205));
	literals.put(new ANTLRHashString("switch", this), Integer.valueOf(124));
	literals.put(new ANTLRHashString("descendant", this), Integer.valueOf(202));
	literals.put(new ANTLRHashString("update", this), Integer.valueOf(126));
	literals.put(new ANTLRHashString("every", this), Integer.valueOf(122));
	literals.put(new ANTLRHashString("group", this), Integer.valueOf(145));
	literals.put(new ANTLRHashString("satisfies", this), Integer.valueOf(146));
	literals.put(new ANTLRHashString("div", this), Integer.valueOf(174));
	literals.put(new ANTLRHashString("item", this), Integer.valueOf(115));
	literals.put(new ANTLRHashString("child", this), Integer.valueOf(200));
}
...
tryAgain:
	...
	protected final void mXQDOC_COMMENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			// nongreedy exit test
			if ((LA(1)==':') && (LA(2)==')') && (true)) break _loop585;
	...
	protected final void mEXPR_COMMENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			// nongreedy exit test
			if ((LA(1)==':') && (LA(2)==')') && (true) && (true)) break _loop589;
...
inputState.guessing--;
	...
	protected final void mPRAGMA_END(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		case '\t':  case '\n':  case '\r':  case ' ':
		{
			...
			do {
				// nongreedy exit test
				if ((LA(1)=='#') && (LA(2)==')') && (true)) break _loop672;
				if (((LA(1) >= '\u0003' && LA(1) <= '\ufffe')) && ((LA(2) >= '\u0003' && LA(2) <= '\ufffe')) && ((LA(3) >= '\u0003' && LA(3) <= '\ufffe'))) {
					matchNot(EOF_CHAR);
				}
				else {
