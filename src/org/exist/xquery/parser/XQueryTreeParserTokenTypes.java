...
public interface XQueryTreeParserTokenTypes {
	...
	int LITERAL_in = 117;
	int LITERAL_by = 118;
	int LITERAL_ascending = 119;
	int LITERAL_descending = 120;
	int LITERAL_satisfies = 121;
	...
	int ESCAPE_QUOT = 188;
	int APOS_ATTRIBUTE_CONTENT = 189;
	int ESCAPE_APOS = 190;
	int ELEMENT_CONTENT = 191;
	int XML_COMMENT_END = 192;
	int XML_PI_END = 193;
	int XML_CDATA = 194;
	int LITERAL_collection = 195;
	int LITERAL_validate = 196;
	int XML_PI_START = 197;
	int XML_CDATA_START = 198;
	int XML_CDATA_END = 199;
	int LETTER = 200;
	int DIGITS = 201;
	int HEX_DIGITS = 202;
	int NMSTART = 203;
	int NMCHAR = 204;
	int WS = 205;
	int EXPR_COMMENT = 206;
	int PRAGMA = 207;
	int PRAGMA_CONTENT = 208;
	int PRAGMA_QNAME = 209;
