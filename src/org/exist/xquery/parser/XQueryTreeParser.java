...
import org.exist.xquery.InstanceOfExpression;
import org.exist.xquery.Intersection;
...
import org.exist.xquery.QuantifiedExpression;
import org.exist.xquery.RangeExpression;
...
import org.exist.xquery.TypeswitchExpression;
			...
			case GROUP_BY:
			{
				...
				do {
					...
					if ((_tokenSet_0.member(_t.getType()))) {
						...
						if ( _cnt112>=1 ) { break _loop112; } else {throw new NoViableAltException(_t);}
					}
 ...
 */
	...
	public final void importDecl(AST _t,
		...
		org.exist.xquery.parser.XQueryAST at1 = null;
		...
		case SCHEMA_IMPORT:
		{
			...
			case STRING_LITERAL:
			{
				at1 = (org.exist.xquery.parser.XQueryAST)_t;
				match(_t,STRING_LITERAL);
				_t = _t.getNextSibling();
				location = at1.getText();
				break;
			}
			case 3:
			{
