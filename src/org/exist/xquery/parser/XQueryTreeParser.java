// $ANTLR : "XQuery.g" -> "XQueryTreeParser.java"$
...
public XQueryTreeParser() {
	...
	public final Expression  expr(AST _t,
		...
		case LITERAL_return:
		{
			...
			do {
				...
				case LITERAL_for:
				{
					...
					do {
						...
						if ((_t.getType()==VARIABLE_BINDING)) {
							...
							if ( _cnt310>=1 ) { break _loop310; } else {throw new NoViableAltException(_t);}
						}
				...
				default:
				{
					if ( _cnt317>=1 ) { break _loop317; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt317++;
			} while (true);
	...
	private static final long[] mk_tokenSet_0() {
		long[] data = { 7214780372715470736L, -6757598464573348L, 4111L, 0L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_0 = new BitSet(mk_tokenSet_0());
	private static final long[] mk_tokenSet_1() {
		long[] data = { 9007199257362432L, 1125899906842624L, 4096L, 0L, 0L, 0L};
		return data;
	}
