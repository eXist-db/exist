...
public interface XQueryParserTokenTypes {
	...
	int LITERAL_ancestor = 127;
	// "ancestor-or-self" = 128
	// "preceding-sibling" = 129
	int DOUBLE_LITERAL = 130;
	int DECIMAL_LITERAL = 131;
	int INTEGER_LITERAL = 132;
	int LITERAL_comment = 133;
	// "processing-instruction" = 134
	// "document-node" = 135
	int END_TAG_START = 136;
	int QUOT = 137;
	int ATTRIBUTE_CONTENT = 138;
	int ELEMENT_CONTENT = 139;
	int XML_COMMENT_END = 140;
	int XML_PI = 141;
	int XML_PI_END = 142;
