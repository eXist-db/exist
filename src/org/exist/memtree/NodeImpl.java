...
public class NodeImpl implements NodeAtExist, NodeValue
{
    ...
    public boolean equals( Object obj )
    {
        ...
        return( ( document == o.document ) && ( nodeNumber == o.nodeNumber ) && ( getNodeType() == o.getNodeType() ) );
    }
...
//        throw new RuntimeException("Can not call hasChildNodes() on node type " + this.getNodeType());
    ...
    public String getStringValue()
    {
        ...
        while( ( next < document.size ) && ( document.treeLevel[next] > level ) ) {
            ...
            if( ( document.nodeKind[next] == Node.TEXT_NODE ) || ( document.nodeKind[next] == Node.CDATA_SECTION_NODE ) ) {
