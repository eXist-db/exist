...
public class Copy extends AbstractWebDAVMethod {
    ...
    private void copyResource(UserImpl user, DBBroker broker,
    ...
    private void copyCollection(UserImpl user, DBBroker broker, HttpServletRequest request, HttpServletResponse response,
