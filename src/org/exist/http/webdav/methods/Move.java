...
public class Move extends AbstractWebDAVMethod {
    ...
    private void moveCollection(UserImpl user, DBBroker broker, HttpServletRequest request, HttpServletResponse response, 
    ...
    private void moveResource(UserImpl user, DBBroker broker, HttpServletRequest request, HttpServletResponse response, 
