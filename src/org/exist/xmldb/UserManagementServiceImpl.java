...
public class UserManagementServiceImpl implements UserManagementService {
    ...
    public void chmod( Resource res, String mode ) throws XMLDBException {
        String path = ( (CollectionImpl) res.getParentCollection() ).getPath() +
            '/' + res.getId();
        try {
            Vector params = new Vector();
    ...
    public Permission getPermissions( Collection coll ) throws XMLDBException {
        ...
        try {
            ...
            Hashtable result = (Hashtable)
                parent.getClient().execute( "getPermissions", params );
            Permission perm = new Permission( (String) result.get( "owner" ),
    ...
    public Permission[] listResourcePermissions() throws XMLDBException {
        try {
            ...
            Vector result = (Vector)
                parent.getClient().execute( "listDocumentPermissions", params );
    ...
    public Permission[] listCollectionPermissions() throws XMLDBException {
        try {
            ...
            params.addElement( parent.getPath() );
            Vector result = (Vector)
                parent.getClient().execute( "listCollectionPermissions", params );
            Permission perm[] = new Permission[result.size()];
            Vector t;
            for(int i = 0; i < result.size(); i++) {
                t = (Vector)result.elementAt(i);
    ...
    public User getUser( String name ) throws XMLDBException {
        try {
            ...
            Hashtable tab = (Hashtable)
                parent.getClient().execute( "getUser", params );
