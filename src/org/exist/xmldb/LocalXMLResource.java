...
public class LocalXMLResource implements XMLResource {
    ...
    private static Logger LOG =
        Logger.getLogger( LocalXMLResource.class );
    ...
    public LocalXMLResource( User user, BrokerPool pool,
                             LocalCollection parent,
                             String docId, long id )
    ...
    public LocalXMLResource( User user, BrokerPool pool, LocalCollection parent,
                             String did, long id, boolean indent )
         throws XMLDBException {
        this.user = user;
    ...
    public LocalXMLResource( User user, BrokerPool pool, LocalCollection parent,
                             DocumentImpl doc, long id, boolean indent )
         throws XMLDBException {
        this.user = user;
        this.brokerPool = pool;
        this.parent = parent;
    ...
    protected void getDocument( DBBroker broker ) throws XMLDBException {
        if( document != null )
            return;
        try {
            String path = ( parent.getPath().equals( "/" ) ? '/' + docId :
    ...
    */
    ...
    public void setContentAsDOM( Node root ) throws XMLDBException {
        OutputFormat format =
            new OutputFormat( "xml", encoding, false );
