...
public interface EXistXQueryService extends XQueryService {
    ...
    ResourceSet execute(XMLResource res, CompiledExpression expression) throws XMLDBException;
     ...
     * @throws XMLDBException
     */
    void dump(CompiledExpression expression, Writer writer) throws XMLDBException;
}
