...
public abstract class AbstractEXistResource implements EXistResource {
	...
	public AbstractEXistResource(UserImpl user, BrokerPool pool, LocalCollection parent, XmldbURI docId, String mimeType) {
		this.user = user;
		this.pool = pool;
		this.parent = parent;
	 ...
	 */
	public AbstractEXistResource(UserImpl user, BrokerPool pool, LocalCollection parent, String docId, String mimeType) {
