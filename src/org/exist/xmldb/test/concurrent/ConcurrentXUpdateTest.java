...
public class ConcurrentXUpdateTest extends ConcurrentTestBase {
	...
	protected void setUp() throws Exception {
		...
		addAction(new RemoveAppendAction(URI + "/C1", "R1.xml", wordList), 100, 500, 500);
		addAction(new RemoveAppendAction(URI + "/C1", "R1.xml", wordList), 100, 300, 500);
//		addAction(new RetrieveResourceAction(URI + "/C1", "R1.xml"), 10, 1000, 2000);
		addAction(new XQueryAction(URI + "/C1", "R1.xml", query), 200, 100, 100);
	}
