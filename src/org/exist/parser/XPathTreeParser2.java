...
public XPathTreeParser2() {
			...
			do {
				...
				if ((_t.getType()==ATTRIBUTE)) {
					...
					do {
						...
						default:
						{
							if ( _cnt379>=1 ) { break _loop379; } else {throw new NoViableAltException(_t);}
						}
						}
						_cnt379++;
					} while (true);
	...
	private static final long[] mk_tokenSet_0() {
		long[] data = { -5651348960558022768L, 1152895107737841664L, 32L, 0L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_0 = new BitSet(mk_tokenSet_0());
	private static final long[] mk_tokenSet_1() {
		long[] data = { 562949956042752L, 4398046511104L, 32L, 0L, 0L, 0L};
		return data;
	}
