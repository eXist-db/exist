...
public class ExportGUI extends javax.swing.JFrame {
    ...
    protected boolean checkOutputDir() {
        ...
        if (!dir.exists()) {
            if (JOptionPane.showConfirmDialog(this,
                    "The output directory " + dir.getAbsolutePath() + " does not exist. Create it?", "Confirm",
    ...
    protected boolean startDB() {
        ...
        if (!(confFile.exists() && confFile.canRead())) {
            JOptionPane.showMessageDialog(this, "The selected database configuration file " + confFile.getAbsolutePath()
                    + " does not exist or is not readable.", "Configuration Error", JOptionPane.ERROR_MESSAGE);
            return false;
        }
        try {
    ...
    private void initComponents() {
        ...
        menuQuit.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_Q,
