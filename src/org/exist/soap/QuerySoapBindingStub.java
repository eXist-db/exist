...
public class QuerySoapBindingStub extends org.apache.axis.client.Stub implements org.exist.soap.Query {
    ...
    public byte[] retrieve(int in0, int in1, java.lang.String in2, boolean in3) throws java.rmi.RemoteException {
        ...
        setRequestHeaders(_call);
        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Integer(in0), new java.lang.Integer(in1), in2, new java.lang.Boolean(in3)});
    ...
    public byte[] retrieveByDocument(int in0, int in1, java.lang.String in2, java.lang.String in3, boolean in4) throws java.rmi.RemoteException {
        ...
        setRequestHeaders(_call);
        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Integer(in0), new java.lang.Integer(in1), in2, in3, new java.lang.Boolean(in4)});
