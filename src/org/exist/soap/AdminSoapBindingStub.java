...
public class AdminSoapBindingStub extends org.apache.axis.client.Stub implements org.exist.soap.Admin {
    ...
    static {
        ...
        oper.setName("store");
        oper.addParameter(new javax.xml.namespace.QName("", "in0"), new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "base64Binary"), byte[].class, org.apache.axis.description.ParameterDesc.IN, false, false);
