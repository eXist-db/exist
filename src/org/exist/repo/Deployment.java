...
public class Deployment {
     ...
     */
    private void scanDirectory(File directory, XmldbURI target,InMemoryNodeSet resources, boolean inRootDir, boolean isResourcesDir) throws XPathException {
        final TransactionManager mgr = broker.getBrokerPool().getTransactionManager();
        ...
        for (final File file : files) {
            if (file.isDirectory()) {
                scanDirectory(file, target.append(file.getName()),resources, false, isResourcesDir);
            }
        }
    }
