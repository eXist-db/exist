...
//    }
     ...
     */
    @Test
    public void addCommit() throws IOException, BrokerPoolServiceException, TransactionException, LogException {
     ...
     */
    @Test
    public void addNoCommit() throws IOException, BrokerPoolServiceException, TransactionException, LogException {
        final Path blobDbx = temporaryFolder.getRoot().toPath().resolve("blob.dbx");
        final Path blobDir = temporaryFolder.newFolder("blob").toPath();
     ...
     */
    @Test
    public void addCommit_removeCommit() throws IOException, BrokerPoolServiceException, TransactionException, LogException {
        final Path blobDbx = temporaryFolder.getRoot().toPath().resolve("blob.dbx");
        final Path blobDir = temporaryFolder.newFolder("blob").toPath();
     ...
     */
    @Test
    public void addCommit_removeNoCommit() throws IOException, BrokerPoolServiceException, TransactionException, LogException {
        final Path blobDbx = temporaryFolder.getRoot().toPath().resolve("blob.dbx");
        final Path blobDir = temporaryFolder.newFolder("blob").toPath();
     ...
     */
    @Test
    public void addCommit_addCommit() throws IOException, BrokerPoolServiceException, TransactionException, LogException {
        final Path blobDbx = temporaryFolder.getRoot().toPath().resolve("blob.dbx");
        final Path blobDir = temporaryFolder.newFolder("blob").toPath();
     ...
     */
    @Test
    public void addCommit_addNoCommit() throws IOException, BrokerPoolServiceException, TransactionException, LogException {
        final Path blobDbx = temporaryFolder.getRoot().toPath().resolve("blob.dbx");
        final Path blobDir = temporaryFolder.newFolder("blob").toPath();
     ...
     */
    @Test
    public void addCommit_addCommit_removeCommit() throws IOException, BrokerPoolServiceException, TransactionException, LogException {
        final Path blobDbx = temporaryFolder.getRoot().toPath().resolve("blob.dbx");
        final Path blobDir = temporaryFolder.newFolder("blob").toPath();
     ...
     */
    @Test
    public void addCommit_addCommit_removeNoCommit() throws IOException, BrokerPoolServiceException, TransactionException, LogException {
        final Path blobDbx = temporaryFolder.getRoot().toPath().resolve("blob.dbx");
        final Path blobDir = temporaryFolder.newFolder("blob").toPath();
    ...
    private BlobDb newBlobDb(final Path journalDir, final Path blobDbx, final Path blobDir) throws BrokerPoolServiceException, LogException {
