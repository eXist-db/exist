...
-->
<xsl:stylesheet xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:default="http://www.w3.org/1999/xhtml" xmlns:txs="http://www.agencexml.com/txs" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:ajx="http://www.ajaxforms.net/2006/ajx" xmlns:xforms="http://www.w3.org/2002/xforms" xmlns:ev="http://www.w3.org/2001/xml-events" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:exslt="http://exslt.org/common" version="1.0" exclude-result-prefixes="xhtml xforms ev exslt msxsl"><xsl:output method="html" encoding="utf-8" omit-xml-declaration="no" indent="no" doctype-public="-//W3C//DTD XHTML 1.0 Transitional//EN" doctype-system="http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"/>
...
-->
		...
		<xsl:variable xmlns:xsl="http://www.w3.org/1999/XSL/Transform" name="config" select="exslt:node-set($config0)/*"/>
		<!--
		...
		<xsl:template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" match="xhtml:html | html">
			...
			<html xmlns="http://www.w3.org/1999/xhtml">
				<xsl:copy-of select="@*"/>
				<xsl:comment>HTML elements and Javascript instructions generated by XSLTForms r480 - Copyright (C) 2008-2011 &lt;agenceXML&gt; - Alain COUTHURES - http://www.agencexml.com</xsl:comment>
				...
				<head>
					...
					<script type="text/javascript">
						...
						<xsl:text>Core.fileName='xsltforms.optimised.js';
</xsl:text>
						...
						<xsl:text>xforms.loadingtime = d2 - d1;
</xsl:text>
						<xsl:text>} catch (e) {
</xsl:text>
...
<!--
/branches/dataisland/src/xslt/script/xscript.xsl.xml
-->
