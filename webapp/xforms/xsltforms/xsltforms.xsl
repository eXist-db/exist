		...
		<xsl:template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" match="xhtml:html | html">
			...
			<html>
				...
				<head>
					...
					<xsl:copy-of select="xhtml:head/xhtml:* | xhtml:head/comment() | head/title | head/meta | head/style | head/script | head/link | head/comment()"/>
