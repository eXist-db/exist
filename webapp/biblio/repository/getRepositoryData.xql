...
declare variable $driver as xs:string := $scope/repositroy/driver/name/string();
declare variable $database as xs:string := $scope/repositroy/driver/database/string();
declare variable $db-server := $scope/repositroy/driver/db-server/string();
declare variable $user as xs:string := $scope/repositroy/driver/user/string();
