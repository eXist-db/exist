...
{token:"rparen",regex:"[\\])}]"},{token:function(b){return e[b]?"keyword":"identifier"},regex:"[a-zA-Z_$][a-zA-Z0-9_$]*\\b"}],tag:[{token:"text",regex:">",next:"start"},{token:"keyword",regex:"[-_a-zA-Z0-9:]+"},{token:"text",regex:"\\s+"},{token:"string",regex:'".*?"'},{token:"string",regex:"'.*?'"}],cdata:[{token:"text",regex:"\\]\\]>",next:"start"},{token:"text",regex:"\\s+"},{token:"text",regex:"(?:[^\\]]|\\](?!\\]>))+"}],comment:[{token:"comment",regex:".*?--\>",next:"start"},{token:"comment",
regex:".*:\\)",next:"start"},{token:"comment",regex:".+"}]}};d.inherits(b,e);c.XQueryHighlightRules=b});
define("eXide/mode/behaviour/xquery",function(a,c){var d=a("ace/lib/oop"),f=a("ace/mode/behaviour").Behaviour,e=a("ace/mode/behaviour/cstyle").CstyleBehaviour,b=function(b){this.inherit(e,["braces","parens","string_dquotes"]);this.parent=b;this.add("brackets","insertion",function(e,b,a,f,c){return c=="\n"&&(b=a.getCursorPosition(),f.doc.getLine(b.row).substring(b.column,b.column+2)=="</")?(e=this.$getIndent(f.doc.getLine(b.row))+f.getTabString(),f=this.$getIndent(f.doc.getLine(b.row)),{text:"\n"+
e+"\n"+f,selection:[1,e.length,1,e.length]}):!1});this.add("slash","insertion",function(e,a,f,c,d){d=="/"&&(e=f.getCursorPosition(),a=c.doc.getLine(e.row),e.column>0&&a.charAt(e.column-1)=="<"&&(a=a.substring(0,e.column)+"/"+a.substring(e.column),f=c.doc.getAllLines(),f[e.row]=a,b.exec("closeTag",f.join(c.doc.getNewLineCharacter()),e.row)));return!1})};d.inherits(b,f);c.XQueryBehaviour=b});
...
function(e,b,a){return!/^\s+$/.test(b)?!1:/^\s*[\}\)]/.test(a)};this.autoOutdent=function(e,b,a){e=b.getLine(a).match(/^(\s*[\}\)])/);if(!e)return 0;var e=e[1].length,f=b.findMatchingBracket({row:a,column:e});if(!f||f.row==a)return 0;f=this.$getIndent(b.getLine(f.row));b.replace(new h(a,0,a,e-1),f)};this.$getIndent=function(e){return(e=e.match(/^(\s+)/))?e[1]:""};this.toggleCommentLines=function(e,b,a,f){for(var c=!0,d=/^\s*\(:(.*):\)/,e=a;e<=f;e++)if(!d.test(b.getLine(e))){c=!1;break}for(var g=new h(0,
0,0,0),e=a;e<=f;e++)a=b.getLine(e),g.start.row=e,g.end.row=e,g.end.column=a.length,b.replace(g,c?a.match(d)[1]:"(:"+a+":)")}}).call(i.prototype);c.Mode=i});
define("eXide/mode/behaviour/xml",function(a,c){var d=a("ace/lib/oop"),f=a("ace/mode/behaviour").Behaviour,e=a("ace/mode/behaviour/cstyle").CstyleBehaviour;a("eXide/mode/behaviour/xquery");var b=function(b){this.inherit(e,["braces","parens","string_dquotes"]);this.parent=b;this.add("brackets","insertion",function(e,b,a,f,c){return c=="\n"&&(b=a.getCursorPosition(),f.doc.getLine(b.row).substring(b.column,b.column+2)=="</")?(e=this.$getIndent(f.doc.getLine(b.row))+f.getTabString(),f=this.$getIndent(f.doc.getLine(b.row)),
{text:"\n"+e+"\n"+f,selection:[1,e.length,1,e.length]}):!1});this.add("slash","insertion",function(e,a,f,c,d){d=="/"&&(e=f.getCursorPosition(),a=c.doc.getLine(e.row),e.column>0&&a.charAt(e.column-1)=="<"&&(a=a.substring(0,e.column)+"/"+a.substring(e.column),f=c.doc.getAllLines(),f[e.row]=a,b.exec("closeTag",f.join(c.doc.getNewLineCharacter()),e.row)));return!1})};d.inherits(b,f);c.XMLBehaviour=b});
define("eXide/mode/xml",function(a,c){var d=a("ace/lib/oop"),f=a("ace/mode/xml").Mode,e=a("ace/tokenizer").Tokenizer,b=a("ace/mode/xml_highlight_rules").XmlHighlightRules,g=a("eXide/mode/behaviour/xml").XMLBehaviour,h=a("ace/range").Range,i=function(a){this.$tokenizer=new e((new b).getRules());this.$behaviour=new g(a)};d.inherits(i,f);(function(){this.toggleCommentLines=function(e,b,a,f){for(var c=!0,d=/^\s*<\!--(.*)--\>/,e=a;e<=f;e++)if(!d.test(b.getLine(e))){c=!1;break}for(var g=new h(0,0,0,0),
e=a;e<=f;e++)a=b.getLine(e),g.start.row=e,g.end.row=e,g.end.column=a.length,b.replace(g,c?a.match(d)[1]:"<\!--"+a+"--\>")}}).call(i.prototype);c.Mode=i});
define("eXide/mode/html",function(a,c){var d=a("ace/lib/oop"),f=a("ace/mode/html").Mode,e=a("ace/tokenizer").Tokenizer,b=a("ace/mode/html_highlight_rules").HtmlHighlightRules,g=a("eXide/mode/behaviour/xml").XMLBehaviour,h=a("ace/range").Range,i=function(a){this.$tokenizer=new e((new b).getRules());this.$behaviour=new g(a)};d.inherits(i,f);(function(){this.toggleCommentLines=function(e,b,a,f){for(var c=!0,d=/^\s*<\!--(.*)--\>/,e=a;e<=f;e++)if(!d.test(b.getLine(e))){c=!1;break}for(var g=new h(0,0,0,
0),e=a;e<=f;e++)a=b.getLine(e),g.start.row=e,g.end.row=e,g.end.column=a.length,b.replace(g,c?a.match(d)[1]:"<\!--"+a+"--\>")}}).call(i.prototype);c.Mode=i});var eXide=eXide||{};eXide.namespace=function(a){var a=a.split("."),c=eXide,d;a[0]=="eXide"&&(a=a.slice(1));for(d=0;d<a.length;d++)typeof c[a[d]]=="undefined"&&(c[a[d]]={}),c=c[a[d]];return c};eXide.namespace("eXide.util");
...
f.addCommand({name:"autocomplete",bindKey:a("Ctrl-Space","Ctrl-Space"),exec:function(){d.autocomplete()}});f.addCommand({name:"nextTab",bindKey:a("Ctrl-Shift-PageDown","Command-Shift-PageDown"),exec:function(){d.nextTab()}});f.addCommand({name:"previousTab",bindKey:a("Ctrl-Shift-PageUp","Command-Shift-PageUp"),exec:function(){d.previousTab()}});f.addCommand({name:"functionDoc",bindKey:a("F1","F1"),exec:function(){d.exec("showFunctionDoc")}});f.addCommand({name:"gotoDefinition",bindKey:a("F3","F3"),
exec:function(){d.exec("gotoDefinition")}});f.addCommand({name:"searchIncremental",bindKey:a("Ctrl-F","Command-F"),exec:function(){d.quicksearch.start()}});f.addCommand({name:"findModule",bindKey:a("F4","F4"),exec:function(){var e=d.getActiveDocument();eXide.find.Modules.select(e.syntax)}});f.addCommand({name:"indentOrParam",bindKey:a("Tab","Tab"),exec:function(){var e=d.getActiveDocument();(!e.template||!e.template.nextParam())&&d.editor.indent()}});f.addCommand({name:"escape",bindKey:a("Esc","Esc"),
exec:function(){d.getActiveDocument().template=null;d.editor.clearSelection()}});f.addCommand({name:"dbManager",bindKey:a("Ctrl-Shift-M","Command-Shift-M"),exec:function(){eXide.app.manage()}})},help:function(a,f){$(a).find("table").each(function(){this.innerHTML="";var e=f.editor.commands;for(key in e.commands){var a=e.commands[key],d=document.createElement("tr"),h=document.createElement("td");h.appendChild(document.createTextNode(a.name));d.appendChild(h);h=document.createElement("td");a.bindKey&&
(c.isMac?h.appendChild(document.createTextNode(a.bindKey.mac)):h.appendChild(document.createTextNode(a.bindKey.win)));d.appendChild(h);this.appendChild(d)}})}}}();eXide.namespace("eXide.edit.ModeHelper");eXide.edit.ModeHelper=function(){Constr=function(a){this.parent=a;this.editor=this.parent.editor;this.commands={}};Constr.prototype={addCommand:function(a,c){if(!this.commands)this.commands={};this.commands[a]=c},exec:function(a,c,d){if(this.commands&&this.commands[a]){for(var c=[c],f=0;f<d.length;f++)c.push(d[f]);$.log("Calling command %s ...",a);this.commands[a].apply(this,c)}else eXide.util.message("Not supported in this mode.")}};return Constr}();eXide.namespace("eXide.edit.XQueryModeHelper");
eXide.edit.XQueryModeHelper=function(){function a(a){var e;e=a.line?a["#text"]:a;var b=d.exec(e),c=-1;b?c=parseInt(b[1])-1:a.line&&(c=parseInt(a.line)-1);return{line:c,msg:e}}var c=/^[\$\w:\-_\.]+/;Constr=function(a){this.parent=a;this.editor=this.parent.editor;this.addCommand("showFunctionDoc",this.showFunctionDoc);this.addCommand("gotoDefinition",this.gotoDefinition);this.addCommand("locate",this.locate);this.addCommand("closeTag",this.closeTag);this.addCommand("importModule",this.importModule)};
...
{label:j[l].signature?j[l].signature:j[l].name,type:j[l].type};if(j[l].help)o.tooltip=j[l].help;i.push(o)}c.$addTemplates(e,i);c.$showPopup(a,b,i)},error:function(e,a){eXide.util.error(a)}})};Constr.prototype.templateLookup=function(a,e,b){var d=[];this.$addTemplates(e,d);this.$showPopup(a,b,d)};Constr.prototype.$addTemplates=function(a,e){for(var b=this.parent.outline.getTemplates(a),d=0;d<b.length;d++)e.push({type:"template",label:"[S] "+b[d].name,tooltip:b[d].help,template:b[d].template})};Constr.prototype.$showPopup=
...
eXide.app.$doOpenDocument(b)):a.switchTo(c)},locate:function(b,c,d){if(c==null)a.exec("locate",b,d);else{$.log("Locating %s in document %s",d,c);var e=a.getDocument(c);e==null?(c={name:c.match(/[^\/]+$/),path:c},eXide.app.$doOpenDocument(c,function(){a.exec("locate",b,d)})):(a.switchTo(e),a.exec("locate",b,d))}},openDocument:function(){d.reload(["reload"],"open");$("#open-dialog").dialog("option","title","Open Document");$("#open-dialog").dialog("option","buttons",{cancel:function(){$(this).dialog("close");
a.focus()},open:eXide.app.openSelectedDocument});$("#open-dialog").dialog("open")},openSelectedDocument:function(a){var b=d.getSelection();b&&eXide.app.$doOpenDocument(b);(a==void 0||a)&&$("#open-dialog").dialog("close")},$doOpenDocument:function(b,c){b.path=eXide.util.normalizePath(b.path);var d=a.getDocument(b.path);d?a.switchTo(d):$.ajax({url:"modules/load.xql?path="+b.path,dataType:"text",success:function(d,e,f){e=eXide.util.mimeTypes.getMime(f.getResponseHeader("Content-Type"));a.openDocument(d,
...
c.container.form({done:function(){var a=c.container.find("form").serialize();$.ajax({url:"modules/deployment.xql",type:"POST",data:a,success:function(){c.container.dialog("close")},error:function(a){eXide.util.error(a.responseText)}})},cancel:function(){c.container.dialog("close")}});c.container.find(".author-repeat").repeat("#author-add-trigger",{deleteTrigger:"#author-remove-trigger"});c.container.dialog("open")},error:function(a){eXide.util.error(a.responseText)}})},deploy:function(a){eXide.util.Dialog.input("Deploy",
'<p>Note: target has to be different from the source package or it will be overwritten!</p><p><label for="target">Target collection:</label><input id="deployment-target" type="text" name="target" value="'+a+'-test"size="30"/></p>',function(){var c=$("#deployment-target").val();c===""&&(c=a);$.ajax({url:"modules/deployment.xql",type:"POST",dataType:"json",data:{collection:a,target:c,deploy:"true"},success:function(a){a=location.protocol+"//"+location.hostname+":"+location.port+"/exist/apps/"+a+"/";
...
"modules/deployment.xql?download=true&collection="+encodeURIComponent(a)},synchronize:function(a){var c=this;c.projects.getProject(a,function(a){a.isAdmin?(c.currentProject=a,c.syncDialog.find(".project-name").text(a.abbrev),c.syncDialog.find('input[name="start"]').val(a.deployed),a.dir&&c.syncDialog.find('input[name="dir"]').val(a.dir),c.syncDialog.find('input[name="collection"]').val(a.root),c.syncDialog.find('input[name="auto"]').val(a.autoSync?"on":"off"),c.syncDialog.dialog("open")):eXide.util.error("You need to be logged in as an admin user with dba role to use this feature.")})},
autoSync:function(a){(a=this.projects.getProjectFor(a))&&a.autoSync&&$.ajax({url:"modules/synchronize.xql",type:"GET",data:{collection:a.root,start:a.deployed,dir:a.dir},success:function(){eXide.util.message("Synchronized directory")}})},runApp:function(a){this.projects.getProject(a,function(a){var d="/exist/apps/"+a.root.replace(/^\/db\//,"")+"/";eXide.util.Dialog.message("Run Application "+a.abbrev,'<p>Click on the following link to open your application:</p><center><a href="'+d+'" target="_new">'+
d+"</a></center>")})},saveState:function(){this.projects.saveState()},restoreState:function(){this.projects.restoreState()}};return Constr}();eXide.namespace("eXide.edit.Template");
...
[e,a.data.writable])},onPostInit:function(){var a=null;c.selected&&(a=this.getNodeByKey(c.selected));a==null&&(a=this.getNodeByKey("/db"));a.activate();a.expand(!0)}})};Constr.prototype={getSelection:function(){return this.selected},getSelected:function(){return{isCollection:!1,name:this.selected}},reload:function(){$.log("Reloading tree...");this.container.dynatree("getTree").reload()},createCollection:function(){var a=this;eXide.app.$checkLogin()&&eXide.util.Dialog.input("Create Collection",'<label for="collection">Name: </label><input type="text" name="collection" id="eXide-browse-collection-name"/>',
function(){$.getJSON("modules/collections.xql",{create:$("#eXide-browse-collection-name").val(),collection:a.selected},function(c){c.status=="fail"?eXide.util.Dialog.warning("Create Collection Error",c.message):a.reload()})})},deleteCollection:function(){var a=this;eXide.util.Dialog.input("Confirm Deletion","Are you sure you want to delete collection "+a.selected+"?",function(){$.getJSON("modules/collections.xql",{remove:a.selected},function(c){c.status=="fail"?eXide.util.Dialog.warning("Delete Collection Error",
...
{editable:!1,multiSelect:!0};Constr=function(c){var e=this;this.container=$(c);this.clipboard=[];this.clipboardMode="copy";this.events={activate:[],activateCollection:[],activateParent:[]};this.mode="save";this.collection=null;this.data=[];this.grid=new Slick.Grid(this.container,this.data,a,d);var b=new Slick.RowSelectionModel({selectActiveRow:!0});this.grid.setSelectionModel(b);b.onSelectedRangesChanged.subscribe(function(){var a=b.getSelectedRows();if(e.data.length!=0){for(var c=!0,d=0;d<a.length;d++)if(e.data.length>
a[d]&&!e.data[a[d]].writable){c=!1;break}e.$triggerEvent("activate",[a.length==1&&!e.data[a[0]].isCollection?e.data[a[0]]:null,c])}});this.grid.onDblClick.subscribe(function(a){a=e.grid.getCellFromEvent(a);e.data[a.row].isCollection&&e.$triggerEvent("activateCollection",[e.collection+"/"+e.data[a.row].name])});this.grid.onKeyDown.subscribe(function(a){if(!a.shiftKey&&!a.altKey&&!a.ctrlKey)if(a.which==13)a.stopPropagation(),a.preventDefault(),a=b.getSelectedRows(),a.length==1&&(e.data[a[0]].isCollection?
e.$triggerEvent("activateCollection",[e.collection+"/"+e.data[a[0]].name]):eXide.app.openSelectedDocument());else if(a.which==8){var c=e.collection.lastIndexOf("/");c>0&&(a.stopPropagation(),a.preventDefault(),e.collection!="/db"&&(a=e.collection.substring(0,c),e.$triggerEvent("activateCollection",[a])))}});this.grid.onViewportChanged.subscribe(function(){var a=e.grid.getViewport();e.load(a.top,a.bottom)})};Constr.prototype={setMode:function(a){this.mode=a;a=="manage"?this.grid.setOptions(d):this.grid.setOptions(c)},
resize:function(){this.grid.resizeCanvas();this.container.find(".grid-canvas").focus()},update:function(a){$.log("Opening collection %s",a);this.collection=a;this.grid.invalidate();this.data.length=0;this.grid.getSelectionModel().setSelectedRanges([]);this.grid.onViewportChanged.notify()},load:function(a,c){var b=this;$.getJSON("modules/collections.xql",{root:this.collection,view:"r",start:a,end:c},function(d){for(var h=a;h<=c;h++)b.grid.invalidateRow(h);if(d&&d.items){b.data.length=d.total;for(h=
0;h<d.items.length;h++)b.data[a+h]=d.items[h]}else b.data.length=0;b.grid.updateRowCount();b.grid.render();a==0&&(b.grid.setActiveCell(0,0),b.grid.setSelectedRows([0]),b.container.find(".grid-canvas").focus())})},hasSelection:function(){var a=this.grid.getSelectionModel().getSelectedRows();return a&&a.length>0},getSelected:function(){var a=this.grid.getSelectionModel().getSelectedRows();if(a.length==0)return null;for(var c=[],b=0;b<a.length;b++)c.push(this.collection+"/"+this.data[a[b]].name);return c},
...
eXide.browse.Browser=function(){function a(a,d,f,e,b){var g=document.createElement("button");g.title=d;g.id="eXide-browse-toolbar-"+f;g.tabindex=e;d=document.createElement("img");d.src="resources/images/"+b;g.appendChild(d);a.append(g);return g}Constr=function(c){var d=this,f=$(".eXide-browse-toolbar",c),e=a(f,"Reload","reload",1,"arrow_refresh.png");$(e).click(function(){d.collections.reload()});this.btnCreateCollection=a(f,"Create Collection","create",3,"folder_add.png");$(this.btnCreateCollection).click(function(a){a.preventDefault();
d.collections.createCollection()});this.btnUpload=a(f,"Upload Files","upload",4,"database_add.png");$(this.btnUpload).click(function(a){a.preventDefault();$(".eXide-browse-resources",c).hide();$(".eXide-browse-upload",c).show()});this.btnDeleteResource=a(f,"Delete","delete-resource",5,"bin.png");$(this.btnDeleteResource).click(function(a){a.preventDefault();d.resources.deleteResource()});e=a(f,"Open Selected","open",6,"page_edit.png");$(e).click(function(a){a.preventDefault();eXide.app.openSelectedDocument(!1)});
this.btnCopy=a(f,"Copy","copy",7,"page_copy.png");this.btnCut=a(f,"Cut","cut",8,"cut.png");this.btnPaste=a(f,"Paste","paste",9,"page_paste.png");this.selection=$(".eXide-browse-form input",c);this.container=c;this.resources=new eXide.browse.ResourceBrowser($(".eXide-browse-resources",c));this.collections=new eXide.browse.CollectionBrowser($(".eXide-browse-collections",c));this.upload=new eXide.browse.Upload($(".eXide-browse-upload",c).hide());this.layout=null;this.collections.addEventListener("activate",
this,this.onActivateCollection);this.collections.addEventListener("activate",this.resources,this.resources.update);this.collections.addEventListener("activate",this.upload,this.upload.update);this.resources.addEventListener("activate",this,this.onActivateResource);this.resources.addEventListener("activateCollection",this,this.onChangeCollection);this.upload.addEventListener("done",this,function(){$(".eXide-browse-resources",c).show();$(".eXide-browse-upload",c).hide();this.reload()});$(this.btnCopy).click(function(a){a.preventDefault();
d.resources.copy()});$(this.btnCut).click(function(a){a.preventDefault();d.resources.cut()});$(this.btnPaste).click(function(a){a.preventDefault();d.resources.paste()})};Constr.prototype={init:function(){var a=$(this.container).innerHeight()-$(".eXide-browse-form",this.container).height()-25;$(".eXide-browse-panel",this.container).height(a);if(this.layout==null)this.layout=$(".eXide-browse-panel",this.container).layout({enableCursorHotkey:!1,north__resizable:!1,north__closable:!1,north__spacing_open:0,
south__resizable:!1,west__size:200,west__initClosed:!1,west__contentSelector:".eXide-browse-content",center__minSize:300,center__contentSelector:".eXide-browse-content",onresize:function(){this.resources.resize()}}),this.resources.resize()},reload:function(a,d){if(a){$(".eXide-browse-toolbar button",this.container).hide();for(var f=0;f<a.length;f++)$("#eXide-browse-toolbar-"+a[f]).show()}this.resources.setMode(d);d==="open"||d==="save"?$(".eXide-browse-form",this.container).show():$(".eXide-browse-form",
this.container).hide();this.layout!=null&&(this.resize(),this.collections.reload(),this.resources.update(this.collections.getSelection()),$(this.selection).val(""))},resize:function(){var a=$(this.container).innerHeight()-$(".eXide-browse-form",this.container).height()-25;$(".eXide-browse-panel",this.container).height(a);this.layout.resizeAll()},deleteSelected:function(){var a=this.resources.getSelected();a==null&&(a=this.collections.getSelected());for(var d=0;d<a.length;d++)$.log("Selected: %o",
a[d]);var f=this;eXide.util.Dialog.input("Confirm Deletion","Are you sure you want to delete the selected resources?",function(){$.log("Deleting resources %o",a);$.getJSON("modules/collections.xql",{remove:a},function(a){$.log(a.status);a.status=="fail"?eXide.util.Dialog.warning("Delete Error",a.message):f.reload()})})},getSelection:function(){var a=$(this.selection).val();return a==null||a==""?null:{name:a,path:this.collections.getSelection()+"/"+a,writable:!0}},onActivateResource:function(a,d){a?
$(this.selection).val(a.name):$(this.selection).val("");d?$(this.btnDeleteResource).css("display",""):$(this.btnDeleteResource).css("display","none")},onActivateCollection:function(a,d){d?($(this.btnCreateCollection).css("display",""),$(this.btnUpload).css("display",""),$(this.btnDeleteResource).css("display",""),$(this.btnCut).css("display",""),$(this.btnPaste).css("display","")):($(this.btnCreateCollection).css("display","none"),$(this.btnUpload).css("display","none"),$(this.btnDeleteResource).css("display",
"none"),$(this.btnCut).css("display","none"),$(this.btnPaste).css("display","none"));this.resources.update(a,d);this.upload.update(a,d)},onChangeCollection:function(a){this.collections.selected=a;this.collections.reload();this.resources.update(this.collections.getSelection())}};return Constr}();eXide.namespace("eXide.find.IncrementalSearch");
