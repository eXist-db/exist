...
define("eXide/mode/behaviour/xquery",function(a,b){var c=a("ace/lib/oop"),f=a("ace/mode/behaviour").Behaviour,d=a("ace/mode/behaviour/cstyle").CstyleBehaviour,e=function(a){this.inherit(d,["braces","parens","string_dquotes"]);this.parent=a;this.add("brackets","insertion",function(d,a,e,f,b){return b=="\n"&&(a=e.getCursorPosition(),f.doc.getLine(a.row).substring(a.column,a.column+2)=="</")?(d=this.$getIndent(f.doc.getLine(a.row))+f.getTabString(),f=this.$getIndent(f.doc.getLine(a.row)),{text:"\n"+
d+"\n"+f,selection:[1,d.length,1,d.length]}):!1});this.add("slash","insertion",function(d,f,e,b,c){c=="/"&&(d=e.getCursorPosition(),f=b.doc.getLine(d.row),d.column>0&&f.charAt(d.column-1)=="<"&&(f=f.substring(0,d.column)+"/"+f.substring(d.column),e=b.doc.getAllLines(),e[d.row]=f,a.exec("closeTag",e.join(b.doc.getNewLineCharacter()),d.row)));return!1})};c.inherits(e,f);b.XQueryBehaviour=e});
...
define("eXide/mode/behaviour/xml",function(a,b){var c=a("ace/lib/oop"),f=a("ace/mode/behaviour").Behaviour,d=a("ace/mode/behaviour/cstyle").CstyleBehaviour;a("eXide/mode/behaviour/xquery");var e=function(a){this.inherit(d,["braces","parens","string_dquotes"]);this.parent=a;this.add("brackets","insertion",function(d,a,f,e,b){return b=="\n"&&(a=f.getCursorPosition(),e.doc.getLine(a.row).substring(a.column,a.column+2)=="</")?(d=this.$getIndent(e.doc.getLine(a.row))+e.getTabString(),e=this.$getIndent(e.doc.getLine(a.row)),
{text:"\n"+d+"\n"+e,selection:[1,d.length,1,d.length]}):!1});this.add("slash","insertion",function(d,f,e,b,c){c=="/"&&(d=e.getCursorPosition(),f=b.doc.getLine(d.row),d.column>0&&f.charAt(d.column-1)=="<"&&(f=f.substring(0,d.column)+"/"+f.substring(d.column),e=b.doc.getAllLines(),e[d.row]=f,a.exec("closeTag",e.join(b.doc.getNewLineCharacter()),d.row)));return!1})};c.inherits(e,f);b.XMLBehaviour=e});
define("eXide/mode/xml",function(a,b){var c=a("ace/lib/oop"),f=a("ace/mode/xml").Mode,d=a("ace/tokenizer").Tokenizer,e=a("ace/mode/xml_highlight_rules").XmlHighlightRules,g=a("eXide/mode/behaviour/xml").XMLBehaviour,h=a("ace/range").Range,i=function(a){this.$tokenizer=new d((new e).getRules());this.$behaviour=new g(a)};c.inherits(i,f);(function(){this.toggleCommentLines=function(d,a,f,e){for(var b=!0,c=/^\s*<\!--(.*)--\>/,d=f;d<=e;d++)if(!c.test(a.getLine(d))){b=!1;break}for(var g=new h(0,0,0,0),
d=f;d<=e;d++)f=a.getLine(d),g.start.row=d,g.end.row=d,g.end.column=f.length,a.replace(g,b?f.match(c)[1]:"<\!--"+f+"--\>")}}).call(i.prototype);b.Mode=i});
define("eXide/mode/html",function(a,b){var c=a("ace/lib/oop"),f=a("ace/mode/html").Mode,d=a("ace/tokenizer").Tokenizer,e=a("ace/mode/html_highlight_rules").HtmlHighlightRules,g=a("eXide/mode/behaviour/xml").XMLBehaviour,h=a("ace/range").Range,i=function(a){this.$tokenizer=new d((new e).getRules());this.$behaviour=new g(a)};c.inherits(i,f);(function(){this.toggleCommentLines=function(d,a,f,e){for(var b=!0,c=/^\s*<\!--(.*)--\>/,d=f;d<=e;d++)if(!c.test(a.getLine(d))){b=!1;break}for(var g=new h(0,0,0,
0),d=f;d<=e;d++)f=a.getLine(d),g.start.row=d,g.end.row=d,g.end.column=f.length,a.replace(g,b?f.match(c)[1]:"<\!--"+f+"--\>")}}).call(i.prototype);b.Mode=i});var eXide=eXide||{};eXide.namespace=function(a){var a=a.split("."),b=eXide,c;a[0]=="eXide"&&(a=a.slice(1));for(c=0;c<a.length;c++)typeof b[a[c]]=="undefined"&&(b[a[c]]={}),b=b[a[c]];return b};eXide.namespace("eXide.util");
...
mime:"text/css"},dataType:"json",success:function(a){a.status=="error"?eXide.util.error(a.message):eXide.util.message(c+" stored.")},error:function(a){eXide.util.error(a.responseText)}})};return Constr}();eXide.namespace("eXide.edit.Outline");
...
c){return a.name==c.name?0:a.name>c.name?1:-1})},$outlineUpdate:function(a){this.$sortFunctions(a);if(this.currentDoc==a){$("body").layout().open("west");eXide.app.resize();var b=$("#outline");b.empty();for(var c=0;c<a.functions.length;c++){var f=a.functions[c],d=document.createElement("li"),e=document.createElement("a");if(f.signature)e.title=f.signature;var g=$(e);f.type=="function"?g.addClass("t_function"):g.addClass("t_variable");e.href=f.source?"#"+f.source:"#";f.visibility==="private"?g.addClass("private"):
g.addClass("public");e.appendChild(document.createTextNode(f.name));d.appendChild(e);b.append(d);g.click(function(){var a=this.hash.substring(1);$(this).hasClass("t_function")?eXide.app.locate("function",a==""?null:a,$(this).text()):eXide.app.locate("variable",a==""?null:a,$(this).text());return!1})}}},$loadTemplates:function(){var a=this;$.ajax({url:"templates/snippets.xml",dataType:"xml",type:"GET",success:function(b){$(b).find("snippet").each(function(){var c=$(this),b=c.attr("abbrev"),d=c.find("description").text(),
...
this.editor);$("#tab-next").button({icons:{primary:"ui-icon-triangle-1-e"},text:!1}).click(function(){e.nextTab()});$("#tab-prev").button({icons:{primary:"ui-icon-triangle-1-w"},text:!1}).click(function(){e.previousTab()});this.lastChangeEvent=(new Date).getTime();this.validateTimeout=null;e.modes={xquery:new eXide.edit.XQueryModeHelper(e),xml:new eXide.edit.XMLModeHelper(e),html:new eXide.edit.XMLModeHelper(e),less:new eXide.edit.LessModeHelper(e)}};eXide.util.oop.inherit(Constr,eXide.events.Sender);
Constr.prototype.init=function(){this.documents.length==0&&this.newDocument()};Constr.prototype.exec=function(){if(this.activeDoc.getModeHelper()){var a=Array.prototype.slice.call(arguments,1);this.activeDoc.getModeHelper().exec(arguments[0],this.activeDoc,a)}else eXide.util.message("Not supported in this mode.")};Constr.prototype.getActiveDocument=function(){return this.activeDoc};Constr.prototype.getText=function(){return this.activeDoc.getText()};Constr.prototype.newDocument=function(a){for(var e=
0,b=0;b<this.documents.length;b++)this.documents[b].path.match(/^__new__(\d+)/)&&(e=parseInt(RegExp.$1));e++;a=typeof a=="string"?new c(a):new c('xquery version "1.0";\n');this.$initDocument(new eXide.edit.Document("new-document "+e,"__new__"+e,a))};Constr.prototype.newDocumentWithText=function(a,e,b){a=new eXide.edit.Document(b.name,b.path,new c(a));a.editable=b.writable;a.mime=e;a.syntax=eXide.util.mimeTypes.getLangFromMime(e);a.saved=!1;b.line&&(a.addToHistory(b.line),this.editor.gotoLine(b.line));
this.$initDocument(a)};Constr.prototype.openDocument=function(a,e,b){b.writable?eXide.util.message("Opening "+b.path):eXide.util.message("Opening "+b.path+" readonly!");a=new eXide.edit.Document(b.name,b.path,new c(a));a.editable=b.writable;a.mime=e;a.syntax=eXide.util.mimeTypes.getLangFromMime(e);a.saved=!0;b.line&&(a.addToHistory(b.line),e=a.$session.getSelection(),e.clearSelection(),e.moveCursorTo(b.line,1),a.$session.setScrollTop(b.line));$.log("opening %s, mime: %s, syntax: %s, line: %i",b.name,
a.mime,a.syntax,b.line);this.$initDocument(a)};Constr.prototype.$initDocument=function(a){var e=this;e.$setMode(a);a.$session.setUndoManager(new f);a.$session.addEventListener("change",function(){if(a.saved)a.saved=!1,e.updateTabStatus(a.path,a);e.triggerCheck()});e.addTab(a);e.editor.setSession(a.$session);e.editor.resize();e.editor.focus()};Constr.prototype.setMode=function(a){this.activeDoc.syntax=a;this.$setMode(this.activeDoc,!0)};Constr.prototype.$setMode=function(a,e){switch(a.getSyntax()){case "xquery":var b=
require("eXide/mode/xquery").Mode;a.$session.setMode(new b(this));if(e)a.mime="application/xquery";break;case "xml":b=require("eXide/mode/xml").Mode;a.$session.setMode(new b(this));if(e)a.mime="application/xml";break;case "html":b=require("eXide/mode/html").Mode;a.$session.setMode(new b(this));if(e)a.mime="text/html";break;case "javascript":b=require("ace/mode/javascript").Mode;a.$session.setMode(new b);if(e)a.mime="application/x-javascript";break;case "css":b=require("ace/mode/css").Mode;a.$session.setMode(new b);
if(e)a.mime="text/css";break;case "text":if(b=require("ace/mode/text").Mode,a.$session.setMode(new b),e)a.mime="text/text";case "less":if(b=require("ace/mode/less").Mode,a.$session.setMode(new b),e)a.mime="application/less"}a.setModeHelper(this.modes[a.getSyntax()])};Constr.prototype.closeDocument=function(){this.$triggerEvent("close",[this.activeDoc]);$('#tabs a[title="'+this.activeDoc.path+'"]').parent().remove();for(var a=0;a<this.documents.length;a++)this.documents[a].path==this.activeDoc.path&&
this.documents.splice(a,1);this.documents.length==0?this.newDocument():(this.activeDoc=this.documents[this.documents.length-1],$('#tabs a[title="'+this.activeDoc.path+'"]').addClass("active"),this.editor.setSession(this.activeDoc.$session),this.editor.resize(),this.$triggerEvent("activate",[this.activeDoc]))};Constr.prototype.saveDocument=function(a,e,b){var c=this,f=c.activeDoc.path,j=c.activeDoc.name;if(a)c.activeDoc.path=a.path,c.activeDoc.name=a.name;eXide.util.message("Storing resource "+c.activeDoc.name+
"...");a={path:c.activeDoc.path,data:c.activeDoc.getText()};if(c.activeDoc.mime)a.mime=c.activeDoc.mime;$.ajax({url:"modules/store.xql",type:"POST",data:a,dataType:"json",success:function(a){a.status=="error"?b?b.apply(c.activeDoc,[a.message]):eXide.util.error(a.message):(c.activeDoc.saved=!0,c.updateTabStatus(f,c.activeDoc),e?e.apply(c.activeDoc):eXide.util.message(c.activeDoc.name+" stored."),(a=c.activeDoc.getModeHelper())&&a.documentSaved&&a.documentSaved(c.activeDoc))},error:function(a){c.activeDoc.path=
f;c.activeDoc.name=j;b?b.apply(c.activeDoc,a.responseText):eXide.util.error(a.responseText)}})};Constr.prototype.getDocument=function(a){for(var a=eXide.util.normalizePath(a),b=0;b<this.documents.length;b++)if(this.documents[b].path==a)return this.documents[b]};Constr.prototype.onInput=function(a,b){var c=a.getModeHelper();if(c&&c.onInput)c.onInput(a,b)};Constr.prototype.autocomplete=function(){var a=this.activeDoc.getModeHelper();a&&a.autocomplete&&a.autocomplete(this.activeDoc)};Constr.prototype.getHeight=
function(){return $(this.container).height()};Constr.prototype.resize=function(){this.editor.resize()};Constr.prototype.clearErrors=function(){this.editor.getSession().clearAnnotations()};Constr.prototype.forEachDocument=function(a){for(var b=0;b<this.documents.length;b++)a(this.documents[b])};Constr.prototype.addTab=function(a){var b=this,c="t"+b.tabCounter++,f=a.name;a.saved||(f+="*");$("#tabs li a").removeClass("active");var i=document.createElement("li"),j=document.createElement("a");j.appendChild(document.createTextNode(f));
j.className="tab active";j.id=c;j.title=a.path;i.appendChild(j);$("#tabs").append(i);$(j).click(function(c){c.preventDefault();b.switchTo(a)});b.activeDoc=a;b.documents.push(a);b.$triggerEvent("activate",[a]);b.scrollToTab($(j))};Constr.prototype.nextTab=function(){if(!(this.documents.length<2)){for(var a=0,b=0;b<this.documents.length;b++)if(this.documents[b]==this.activeDoc){a=b;break}a==this.documents.length-1?a=0:a++;this.switchTo(this.documents[a])}};Constr.prototype.previousTab=function(){if(!(this.documents.length<
2)){for(var a=0,b=0;b<this.documents.length;b++)if(this.documents[b]==this.activeDoc){a=b;break}a==0?a=this.documents.length-1:a--;this.switchTo(this.documents[a])}};Constr.prototype.switchTo=function(a){this.editor.setSession(a.$session);this.editor.resize();this.activeDoc=a;var b=this;$("#tabs a").each(function(){var c=$(this);this.title==a.path?(c.addClass("active"),b.scrollToTab(c)):c.removeClass("active")});this.updateStatus("");this.$triggerEvent("activate",[a])};Constr.prototype.updateTabStatus=
function(a,b){var c;c=b.saved?b.name:b.name+"*";$('#tabs a[title="'+a+'"]').attr("title",b.path).text(c)};Constr.prototype.scrollToTab=function(a){var b=a.offset().left,a=b+a.outerWidth(),c=$("#tabs").innerWidth(),f=$("#tabs").scrollLeft();a>c?($("#tab-next").show(),$("#tab-prev").show(),$("#tabs").scrollLeft(a-c)):b<f&&(b<c?$("#tabs").scrollLeft(0):$("#tabs").scrollLeft(b));$.log("Scrolling to %d %d",b,$("#tabs").scrollLeft())};Constr.prototype.setTheme=function(a){$.log("Changing theme to %s",a);
var b=this;b.loadTheme(a,function(){b.editor.setTheme("ace/theme/"+a)})};Constr.prototype.loadTheme=function(a,b){if(this.themes[a])return b();require("ace/lib/net");this.themes[a]=1;var c="resources/scripts/ace/theme-"+a.split("/").pop()+".js",f=document.getElementsByTagName("head")[0],i=document.createElement("script");i.src=c;f.appendChild(i);i.onload=b};Constr.prototype.updateStatus=function(a,b){this.status.innerHTML=a;if(b)this.status.href=b};Constr.prototype.triggerCheck=function(){if(this.activeDoc.getModeHelper()){var a=
this;if(!a.pendingCheck){var b=(new Date).getTime();a.validateTimeout&&b-a.lastChangeEvent<2E3&&clearTimeout(a.validateTimeout);a.lastChangeEvent=b;a.validateTimeout=setTimeout(function(){a.validate.apply(a)},2E3)}}};Constr.prototype.validate=function(){var a=this,b=a.activeDoc.getModeHelper();if(b&&b.validate)a.pendingCheck=!0,$.log("Running validation..."),b.validate(a.activeDoc,a.getText(),function(){a.pendingCheck=!1}),a.$triggerEvent("validate",[a.activeDoc])};Constr.prototype.evalError=function(a){var b=
/.*line\s(\d+)/i.exec(a),c=-1;b&&(c=parseInt(b[1]));$.log("error in line %d",b[1]);this.editor.focus();this.editor.gotoLine(c);b=[{row:c-1,text:a,type:"error"}];this.updateStatus(a);this.editor.getSession().setAnnotations(b)};Constr.prototype.focus=function(){this.editor.focus()};Constr.prototype.saveState=function(){var a=0;$.each(this.documents,function(b,c){c.path.match("^__new__.*")?(localStorage["eXide."+a+".path"]=c.path,localStorage["eXide."+a+".name"]=c.name,localStorage["eXide."+a+".mime"]=
c.mime,localStorage["eXide."+a+".data"]=c.getText(),localStorage["eXide."+a+".last-line"]=c.getCurrentLine()):(localStorage["eXide."+a+".path"]=c.path,localStorage["eXide."+a+".name"]=c.name,localStorage["eXide."+a+".mime"]=c.mime,localStorage["eXide."+a+".writable"]=c.editable?"true":"false",localStorage["eXide."+a+".last-line"]=c.getCurrentLine(),c.saved||(localStorage["eXide."+a+".data"]=c.getText()));a++});localStorage["eXide.documents"]=a};return Constr}();$(document).ready(function(){var a=function(a){if(a=="")return{};for(var c={},f=0;f<a.length;++f){var d=a[f].split("=");d.length==2&&(c[d[0]]=decodeURIComponent(d[1].replace(/\+/g," ")))}return c}(window.location.search.substr(1).split("&"));eXide.app.init(function(b){var c=a.open,f=a.snip;c&&!b[c]?eXide.app.findDocument(a.open):f&&eXide.app.newDocument(f)})});eXide.namespace("eXide.app");
